...
channel: Lex Fridman
url: "https://www.youtube.com/watch?v=sRxaMDDMWQQ"
cover: imgs/cover.jpg
description: Introductory lecture of the MIT Self-Driving Cars series (6.S094) with an overview of the autonomous vehicle industry in 2018 and looking forward to 2019, including Waymo, Tesla, Cruise, Ford, GM, and out-of-the-box ideas of boring tunnels, flying cars, connected vehicles, and more. This covers the
language: en
---

# Self-Driving Cars: State of the Art (2019)

Introductory lecture of the MIT Self-Driving Cars series (6.S094) with an overview of the autonomous vehicle industry in 2018 and looking forward to 2019, including Waymo, Tesla, Cruise, Ford, GM, and out-of-the-box ideas of boring tunnels, flying cars, connected vehicles, and more. This covers the
...
in the time we spend in traffic and transportation.

One of the most hated things
...
in the world dies in a car, auto crash. It should be a sobering, it is for me, thing that I think about every single day.

You go to bed, you wake up, you work on all the deep learning levels, all the different papers are publishing, everything we're trying
...
and obviously is growing and growing by day. And we'll have Drago here from Waymo to talk about their work there.

Then on the L2 on the
...
especially on highway driving. That's the critical thing.
...
iteration of auto pilot hardware there's a neural network.

There's a set of neural
...
classification on ImageNet and you sit there with a tensor flow and you're very happy there.

You were able to achieve a 99. 3 accuracy with a state of the art algorithm. You take from that a step
...
been two fatalities that happened in March of 2018.

One in the fully autonomous side of things with Uber in Tempe, Arizona,
...
disproportionate amount of attention given to these fatalities. And that's something as engineers you have to also think about, that the bar is much higher on every level in terms of performance.

So in order to success, as I'll argue, in order to design successful
...
really have to think about. That's our role as engineers and so on. Question, yeah.
...
and oranges in comparison and that's something actually that we're working on to make sure that we compare it correctly.

Compare the aspects of manual miles that directly are comparable
...
need to be considered when you compare the two.

But when you just look at the numbers, Tesla Autopilot's three times safer than manually driven vehicles. But that's not the
...
Okay, 2018 in review continued. There's been a lot of announcements or rather actual launches of public testing of
...
always, with a safety driver.

There's a few exceptions for demonstration purposes but there's always an
...
publicity in Phoenix, Arizona. That Nuro doing zero occupancy deliveries of groceries autonomously.

So we didn't say has to
...
think about what it means when will they be here?

When will autonomous vehicles arise such that that Uber that
...
it will give you a ride in a particular location. But that's one vehicle, it's not a service and it only works on particular roads.

It's extremely constrained. In some ways it's not much different than most of the companies that
...
So that's what 10,000 feels like some, you know 25, 30 % of the
Uber drivers in New York City all of a sudden are become passengers.

So the predictions, I'm
...
Hyundai and Volvo has in 2021. BMW and Ford, Ford saying at scale, so a large scale deployment 2021. And Chrysler in '21 and Daimler
...
So Carl says that basically teleoperation, kind of gives this analogy of an elevator and the elevators fully autonomous but there is still a
...
historically speaking up to this point.

So they're really the full spectrum, we can think of it as
...
vehicle will be here in 2019 for Rodney the vehicles are really, fully autonomous are beyond 2050.

But there, he believes in the '30s there will be a significant,
...
for cars to be built that are not fully autonomous.

So we also have to think about
...
of vehicles to happen. And so my own view beyond predictions, to take a little pause into the ridiculous and the fun to explain the view.

Yes that is me playing guitar
...
not be adopted by human beings in the near term, in the next 10-15 years, because they're safer.

Safety is not going to, they
...
assertively with speed over the speed limit all the time.

That is not how autonomous
...
adopted by human beings if it creates a better human experience. If there's something about the experience that you enjoy the heck out of.
...
vehicle problem jointly.

So in the language that
...
far as I'm concerned, levels, human center autonomy and full autonomy.

Human centered means the
...
human is still in the loop. It doesn't allow for the 10 second rule that it's gonna be fully autonomous but once it starts warning you, you have 10 seconds to take over.

No, it's not fully autonomous if it cannot guarantee
...
else to find safety. So that's the fully autonomous challenge. And so how do we envision these two levels of automation proliferating society, getting deployed at a mass scale?

The 10,000, 10 million beyond. On the fully autonomous side, the way to think about
it with the predictions that we're talking about here, is there's several different possibilities of how to deploy these vehicles.
...
problem of highway driving with lanes well marked, well mapped routes throughout the United States and globally on the highway driving is automatable.

The specific urban routes kind of like what a lot of the these
...
And then there's the world of zero occupancy ride-sharing delivery. So the Uber that comes to you as opposed to having you drive it yourself and it comes to you autonomously
...
towards most recently, it's on-ramp to off-ramp.

Now the driver is still
...
be driven 200 miles an hour and then you get out of the tunnel.

Of course there's the flying cars, personalized flying car vehicles. I will not, I mean, Rodney as I mentioned before, does believe that we'll have them in 2050. There's a lot of people that
...
be a significant amount of autonomy involved.

One of the people really, one of the companies really
...
autonomous cars operating on public roads without a safety driver.

And several options percolated
...
So it's wide open. But currently Tesla with a human, with the semi-autonomous
...
people's imagination about what's possible.

And a lot of people have said that the autonomous vehicle
...
engineering problem it's not a software problem.

It's not a fundamentally, it's not really an
...
This is a common belief. Not me, not you but everybody else, nobody in this room but everybody
...
in a room with a robot and say watch that robot, they start texting like 15 seconds in.

So that's the fundamental psychology. There's thousands of papers on this. People are, they tune out,
...
So we have to consider that it is not. The driving task is easy because if you think
...
And then you have to deal with a nonverbal communication
...
ambulance didn't slow down that the pedestrian will slow down. Algorithmically we're afraid to do that.

The idea that a pedestrian that's moving, we anticipate their trajectory
...
formalize the objective function under which a planning algorithm operates.
...
to the objective function without a human in the loop. Humans are bad at driving. As I showed yesterday, humans if they're bad at anything it's about having a good intuition about what's hard and what's easy.

The fact that we have 540
...
actually not fully autonomous, there's still some human in the loop. There's just noisy broken communication.

So that, humans are incredible in terms of our ability
...
are actually in the lab. This is the difference.

You put, many of you, you
...
driving these systems. In red shown manually controlled vehicles and cyan showed vehicle control autopilot.

Now there's a lot of details here and we have a lot of presentations on this but really, the fundamentals are, is that they drive 34%, large percentage of the miles in autopilot and in 26,000 moments
...
than the full Tesla fleet that has autopilot. But it's still an inkling.

It's not obvious that it's
...
with the other pedestrians, the vehicles in the scene and then there's teleoperation, vehicle-to-vehicle, vehicle-to-AI.

You have to solve those perfectly if you want to solve the
...
the communication, I think is critical for all of us as we're tweeting as all of us do.

(people chattering) So it's as simple as, so this is just demonstration
of Eco taking control when the attention over time, that the driver is being, okay, we got it thank you.

Okay so basically a smartphone use which has gone up year by year and we're doing a lot of analysis on that, it's really what people do in the car is they use their phone, whether it's manual or autonomous driving or semi-autonomous driving. So being able to manage that,
...
complicated human beings and it's a human robot interaction problem that deserves solving.

But as you'll hear on the beyond
...
and deep learning, right. Collect a huge amount of data. So cameras have this aspect that they're the highest resolution of information available. It's rich texture information and there's a lot of it which is exactly what you know networks love right.

So to be able to cover
...
our roads and our world, is designed for human eyes.

Eyes is the way we perceive the world and so the lane mark is also on is visual, most of the road textures that you use to navigate, to drive are
...
and so that's what I mean by not accurate. It's really difficult to reach that level.

And then the second approach is LIDAR, taking a very particular
...
and it's explainable. If it fails, you can understand why, you can account for those situations.

It's not so much true for
...
not learning over time. And if they were deep learning based, there's a reason they're not, it's 'cause you need a lot of car, you gonna need a lot of LIDAR data.

And there's only a tiny
...
ones that do all the work and they never get the credit. So radar is that.

It's always behind to catch, to actually do the detection
...
right, radar on the left.

The resolution is just much
...
of deep learning. And the challenge is it's noisy, it's bad at depth estimation and it's not good in extreme weather.

So if we kind use this plot to look, to compare these sensors, to compare these different approaches. So LIDAR works in the dark, variable lighting conditions,
...
the problems that radar has.

They complement each other well and radar, cheap, tiny, detect speed and has pretty good range but has terrible resolution. There's very little
...
popular car in America. Manually driven cars are still happening. So there's a lot of data happening.

Semi-autonomous cars, every
...
autonomous front has reached 10 million miles.

The pros and cons as I've outlined them. One, division one, the one I'm
...
have to have a sensor suite that are extremely reliable.

Those are the two paths. Yep, question. The question is there's all
...
visual characteristics all have different characteristics for all the different sensors. So LIDAR can detect of solid-body objects, camera is better at detecting, as last year Sasha Arnu talked about, I think fog or smoke.

These are interesting things. They might look like an object to certain sensors and not to others, But the traffic light
...
pedestrian trying to cross what to do. That's the hard part.

So the road ahead for us as engineers, the science is the thing I'm super excited about the possibility of artificial intelligence
...
to thank you very much, go to deeplearning.

mit. edu and the code is always available online. (people clapping)
