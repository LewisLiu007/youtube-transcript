...
channel: Lex Fridman
url: "https://www.youtube.com/watch?v=ByZF8_-OJNI"
cover: imgs/cover.jpg
description: "This is lecture 5 of course 6.S094: Deep Learning for Self-Driving Cars taught in Winter 2017."
language: en
---
...
detecting body pose, why do we care?

There is a seatbelt design, there are these dummies, crash-test dummies,
...
[chuckles] There's five cameras, this is why we're recording in the Tesla.

This is a Tesla vehicle, in the bottom right,
...
What do you need? One is emotion, You can have—
...
everyone uses now, convolutional neural networks.
...
and you want it to stay that way Yes, question.
...
the subtle expressions of emotion? It's hard, when you're solo.
...
So cognitive load— when the pupil, that black dot in the middle, in case you don't know what a pupil is, in the middle of the eye, when it gets larger that's an indicative
...
the system is observing, happens to be the same TA once again.
...
find 39 points of the eyelids, the iris, and four points on the pupil.

Putting all of that into a 3D CNN model, they're positioned,eye sequence on the left,
...
I think Eric has mentioned this is-- On the-- Oh man, this is the comeback of the slide, [laughter] I was criticized for this being
...
of this emergent concept is the Conway's Game of Life.
...
these networks will be able to reason. What's next? I encourage you to read
...
research in our group, just email me. Anyway, we have three winners, Jeffrey Hu, Michael Gump how do you-- Are you here? How do you say your name? No, that's not my name
[laughter] My name is Purna [? ] Oh, I see.

[? ] Well, anyway here-- [applause] He achieved the stunning speed of--
...
working on a journal paper for this game.

We're trying to find the
optimal solutions. Okay. This is the first time
...
just write your email on the note, on the on the index note. Thank you.
