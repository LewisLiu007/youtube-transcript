...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=TgrLuHOLXf4"
cover: imgs/cover.jpg
description: If you’ve ever wondered if it was possible, it’s true; you can increase your pushups. In this video, I’m going to show you how to increase the number of pushups you can do right now by offering a simple progression of pushup variations to increase the difficulty and intensity of the exercise.
language: en
---
...
And so if your dream has always been to be able to 
...
What s up guys, Jeff Cavaliere, athleanx. com. So look, unless you are in the military right now or your goal is to simply do more 
...
increase the difficulty of the pushup that you're doing. Think about it this way.
...
build their body through pushups? You have to find a more difficult version of the pushup. Something that mechanically challenges those same muscles in a more difficult way to provide 
the progressive overload that you're looking for.
...
start breaking them down one by one. So when you're trying to build muscle with 
...
doing a certain number of pushups or increasing the number of them, you're not ensuring that.
...
focus on something more challenging. So what would the beginners do? Well, let's 
say we start all the way at the bottom a knee pushup.

If you can do 30 knee pushups, it's time 
...
see extend your elbows all the way out.

At that point when you can hit 30, it's time to move on 
to the next exercise, which would be this. And this would now be the classic pushup. So 
...
the elbows. I've made videos all about this in the past.

In fact, Pushups are Killing Your 
...
up to the point where you can do 30 of these, then it's time to move on to the next variation. Well, now the next challenge will become the hand release pushup. And what's interesting about this 
...
any time you slow down tempo on a pushup, it becomes more difficult.
...
firing to hold you there.

But when 30 repetitions of these aren't even able to make your arms quiver 
anymore, well, we still stick with the same theme of tempo, but we move on to a more challenging 
exercise and that's the one and a half pushup. In other words, for every one pushup you're doing, 
...
ability to build more muscle growth for you. But if even those are now no longer providing a 
challenge for you, what are you going to do now?

Well, again, we have another option for tempo, 
...
once, you've increased the difficulty level and you've added that extra component.

But once 
again, your goal here is 30 when you can do 30 of these, once again, it's time to move on. And at that point, the best thing you can do is actually start to decrease the number of points 
...
body weight. So what are we talking about?

Well, we have exercises like the prowler pushup, which 
...
points of contact on the ground and making it more challenging.

And finally, we have the cross knee 
...
so it can produce the growth you're after. But we're not done yet because we can actually 
...
the pushup, the less tricep contribution to the exercise.

That means the chest is going to have 
...
your chest, and this is a great way to do it. But we can become even more challenging and 
dynamic than that and that's with the archer pushup.

And here it's the same wide arm approach, 
with the same effect of minimizing the tricep contribution here and making it more difficult. But the dynamic nature of it shifting the load from left to right and left to right is going 
...
30 count. Well, you still got one more step to go, and that is something much more explosive. And for explosive we're talking about plyometric variations of the pushup.
...
it's time to move on to the pause push up. Once you can knock those out, increase that 
range of motion to one and a half pushups.

From the one and a half pushup, once you're able 
