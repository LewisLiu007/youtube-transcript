...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=DYswqh7FmBg"
cover: imgs/cover.jpg
description: If you want to build a bigger chest you are going to have to lift lighter weights.  Wait, what was that?  That’s right.  While heavy lifting is an important part of the equation when it comes to building a bigger chest it must be complimented with some lighter training or you will not see the best c
language: en
---

# How to Get a Bigger Chest (LIGHT WEIGHTS!!)

If you want to build a bigger chest you are going to have to lift lighter weights.  Wait, what was that?  That’s right.  While heavy lifting is an important part of the equation when it comes to building a bigger chest it must be complimented with some lighter training or you will not see the best c

What's up, guys? Jeff Cavaliere, ATHLEANX. com. Today I want to show you how to build a bigger
...
Through exercises like bench-press, inclined
...
bit here, but it actually works.

So here's what we have to do: you take a much
...
your chest. There are two ways we could do it.

Posturally – I've shown you how to do this
...
But I can get the chest to be more prominent
...
is I'm going to actually try to tighten my armpits.

From here, tighten my armpits. Here, tighten my armpits. Get a little bit of that chest pre-activation. I'm going to show you here in a second as
I stand up what this does. What we're trying to do is that.

I'm not moving my arms. I'm just trying to tighten my armpits and
...
it's how you do this exercise that matters.

We tend to have it fall apart in this place,
...
triceps and from the shoulders that are also helping out with this exercise.

That is the adduction component of your upper
...
to bring this across your body.

That's what it's trying to do. That's what differentiates it from those other
...
bringing it to, about, here.

Down here, to here. When we have so much more room to go. We can adduct it from here, all the way across. There are two things that will help with that. One: changing the direction of the dumbbells
as you come up.

Because, if we come to the top we run out
...
getting them closer, but the elbows are staying out.

So what you want to do is, you want to focus
...
Elbows go out on the way down, pre-activate
...
30lbs here, and I'm used to using a lot more.

However, I'll be damned if my chest ever worked
...
some sets that are lighter, but done with a lot more focus.

I promise you, you will have a much bigger
...
That's what matters the most. I try to coach you through everything we do
