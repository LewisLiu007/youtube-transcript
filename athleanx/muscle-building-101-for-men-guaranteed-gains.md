...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=ZxJlZxZ2KFw"
cover: imgs/cover.jpg
description: If you have been wanting to build muscle but you just haven’t been seeing the results that you have been looking for with other workouts, it is time to rethink your approach.  In this video, I’m going to give you a muscle building 101 course on the most important things you need to focus on when it
language: en
---

# Muscle Building 101 for Men (GUARANTEED GAINS!)

If you have been wanting to build muscle but you just haven’t been seeing the results that you have been looking for with other workouts, it is time to rethink your approach.  In this video, I’m going to give you a muscle building 101 course on the most important things you need to focus on when it
...
you've ever seen on this topic and it might actually throw a few curveballs your way.

I'm going to tell you right now, everything
...
this intensify is not necessarily what I'm talking about. JESSE: S*#T!

DAMN IT! F#%*! F#%*! F#%*! JEFF: Okay, not that.

What we're talking about is an element of
...
somehow earned their man card.

"I did it. I showed up. I'm building muscle. " No, you're not. You haven't done anything yet.

You've just showed up. When you go to the gym you have to have some
...
into the gym and they're doing what they like to call "instinctive training".

Instinctive training doesn't mean "I'm going
...
Or they're like "Well, I know better than
...
actually going to complement each other.

So there's more to it than that, and if you're
...
But we know that there are elements here that
...
have to do something. This is where the second big focus comes in. That is: your effort.

What are you actually doing? How much effort are you exerting when you
...
This is me just doing a set of an inclined
...
It could go 7, 8, 9. People can grow muscle on any of those ranges
if the effort level is there. But in the generally accepted range of 10
to 12, how are you approaching this? Are you stopping just because you hit a number? That's a major mistake.

Instead, let your effort guide you. Push as hard as you can. Try to accomplish something in this set that
...
if I want to train for volume?

If I'm training for volume here I'm going
...
You need to have that accrual of all that
...
that last set for a reason. I actually wasn't finished.

It looked like I might have been done, but
...
It doesn't just have to be this. It can be a super set. It can be a drop set. There are a lot of other techniques that you
...
For once, let your mind be in charge. Let it say "You know what, Jeff? Get your ass back on the bench and give me
another couple reps. " You'll be surprised at what will come out
of your body. I can guarantee you this: more reps.

So use these set intensifier techniques if
...
I hope – and you're looking for a video there.

But that's not what you want to do when you're
...
like to go on the phone – how fast that comes around.

I want you prepared, and ready for the next
...
And don’t train for strength and rest for
...
up your recovery you're never going to build muscle.

It's just like the guy who walks over the
tight rope, he holds that balance beam, he's doing great. Except when he gets right to about, maybe
90% of the way there, if he falls of, guess what he is? He's dead. Not close. He's dead.

You need to approach your recovery the very
...
right. There you have it, guys.

Building muscle 101. It really isn't, as you can see, that complicated. But it's also not easy because it does take
...
step in all of our plans.

The only thing I can't give you: I can't give
...
to know whether you're doing that, or not is you.

I'm trying to encourage you, via this video,
