...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=g-7ZWPCWv0U"
cover: imgs/cover.jpg
description: If you have poor posture, you not only are aware of it but likely would welcome an easy way to fix it.  In this video, I’m showing you a 4 step plan that can attack the most common posture flaws to give you a nice, tall, upright posture sooner than you think.  I’m going to show you how to hit correc
language: en
---

# How to Fix Your Posture in 4 Moves! (PERMANENTLY)

If you have poor posture, you not only are aware of it but likely would welcome an easy way to fix it.  In this video, I’m showing you a 4 step plan that can attack the most common posture flaws to give you a nice, tall, upright posture sooner than you think.  I’m going to show you how to hit correc
...
actually be impossible had he not first fixed his posture.

For anyone that's followed this channel for
...
because you kind of look exactly like I just did. You kind of came to me looking like this.

If you don’t believe me, you can look at
...
right here. The upper back. The thoracic spine being rounded, kyphotic. It's not a good position.

You actually can't lift your arm over your
...
As a compensation for that we know we've got
...
Even because of all his Star Wars infatuation
...
Jesse's got a hell of a case of anterior pelvic tilt. Meaning, he gets that swoop in the low back.

We actually fixed that, and addressed that
...
in the spine – because it's one connected unit – is we get this posterior pelvic tilt.

This tucking under. This ass-not, as we call it. So basically, we have four main issues that
...
I promise you, you're going to start to see better results with your posture. Let's first attack that rounded upper back.

The thoracic kyphosis. Actually, a fun one to do because all it takes
...
and extension together because the spine works that way.
...
out at the end for just a couple of seconds in each direction.

Do five, or six of these in each direction,
...
of the muscles in the chest, and we want to make sure that we're not just focused on that.

Guys, I talk about it all the time. You'd better start learning to pull, pull,
...
basically working on external rotation as well.

So as he gets back he's trying to bring his
...
and then reversing it. so you go here for quality reps.

I'd rather see him go 10 sets of 1 quality
rep at a time, as opposed to doing one set of 10. At least the mentality when you approach this
exercise. So the face pull. Out, keep these arms as wide as you can. Work on externally rotating them.

Trying to pull and push the thumbs back in
...
your chin back so you can really activate the deep neck flexors.

So what you do is take a tennis ball like
...
But the whole time he's engaging those deep
...
quality rep, and quality rep. One at a time.

That's what matters the most. Okay, lastly we have to attack that pelvis. The pelvis is really the base of all the stuff
...
this stuff is rounding forward is it gets tucked underneath.

Why is that? The hamstrings get short, and tight, and they
...
in this position here because it's sinking under, and disappearing.

So if I grab the camera here, I can actually
...
In order to stretch the hamstring out we have
...
But we really try to force our butt out as
...
There's not a lot of forward bend here at
...
neck, hopefully, will work itself out.

But as you increase the deep neck flexor strength
...
You just have to be committed to making the
...
and I promise you're going to start seeing results very, very quickly.

Again, you can feel them instantly. You can start to see them adapt, and become
...
you step by step in every, single workout we do. That's what Jesse's been doing as well.

You can get that over at ATHLEANX. com. In the meantime, if you've found the video
