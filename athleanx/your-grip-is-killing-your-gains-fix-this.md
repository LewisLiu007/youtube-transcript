...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=tnhEJwNutT4"
cover: imgs/cover.jpg
description: Your grip during lifting is killing your gains if you are making any of the mistakes shown in this video. When it comes to reaching training goals, the thing that can derail you faster than anything else is an injury. When the grip is less than ideal (as is often the case with most lifters) then you
language: en
---
...
You see, we're taking back the killing your 
...
turn one of them to face yourself. Which finger is the longest?

For most of you, it should be 
...
God, that's frightening. Okay, look, forget that, hold your hand out.
...
Which one is exerting the most force? You can probably see on mine it's that same ring 
...
when you go grip a bar or a pull-up bar.

This finger tries to dominate, and when it does, it 
...
you've likely at some point in your life dealt with some type of pain on the medial elbow here. It's called medial epicondylitis or golfer's elbow. It's a pretty harsh pain.
...
or FDS to make it a little bit easier for you, Jesse. Yes, it's very difficult for me.
...
finger, and it inserts right here onto that middle interphalangeal joint here, okay, and our fingers. And the other one comes over here and it goes into the pinky. So then we've got this other head that 
...
and it feeds off into the second finger, right, the pointer finger and into the middle finger. Well, because we know how much of a contribution this finger want to make in terms of any time we 
...
bar to show you how to get this right every time.

All right, guys, so here's our make shift 
...
that fourth finger like we talked about.

So how do you do the first thing first? Well, guys, if 
...
you try to test this one out. You shouldn't feel anything, it's the middle finger.
...
back, and then pulling up on this. You probably shouldn't feel much there either.
...
go to overhand pull-ups. You try to widen your grip a little bit too which will help.
...
that bar is being placed deep into your hand.

So if I go and I grab the bar for a pull-up, and I'm 
...
Those other knuckles that we talked about. You don't want that. Because as 
soon as that does, look at all of that stress it's placing right at the end of those tendons. They're hanging on for dear life, and again, this is going to do most of that pulling for the 
...
you're doing this exercise with.

So you only want to see these knuckles. Now, if I switch to a 
...
going to place all of that stress down here at the elbow.

So how do we do the next thing here? The 
...
When you go to do your pull-ups, you put your fourth and finger on top of the band 
...
you'll feel this right way.

If you have elbow pain, and you make this switch, and you're now 
...
show you a couple of things you want to do there.

All right, so now with the barbell work, this 
...
me in the past like bend my wrist back when I do a curl.

It doesn't change the fact that you want to 
...
and stress on that muscle too, which could cause some traction stress on that same point.
...
Now what the hook grip does, ironically, is it actually takes the exact problem that you're 
...
it's the exact solution to the problem you're having right now.
...
now are going to position themselves one over the nail and one behind the knuckle, like that.
...
top of the knuckle. You don't want to be pressing directly down on top of the knuckle.
...
of that long term problem that is going to inhibit your ability to make gains in the gym.
...
All of our programs have built around training for a long time-- for our lifetime. You can find them over at Athleanx. com. If you haven't already done so, guys, make sure you 
