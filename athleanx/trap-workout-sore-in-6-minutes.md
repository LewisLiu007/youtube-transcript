...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=jyFMBf-SrHs"
cover: imgs/cover.jpg
description: "Get the complete program - http://athleanx.com/x/all-included Subscribe to this channel here - http://bit.ly/2b0coMW"
language: en
---

# Trap Workout (SORE IN 6 MINUTES!)

Get the complete program - http://athleanx.com/x/all-included Subscribe to this channel here - http://bit.ly/2b0coMW

What's up, guys? Jeff Cavaliere, ATHLEANX. com. The Sore in Six Minutes series continues,
and this time we're hitting the traps. It's a six minute sequence that you're going
to do.

Again, simple in terms of how we structure
...
that the volume is going to impact that ability to use that.

But you're going to use a heavy weight. For me, here, it's 245. So again, we're not breaking records, but
...
and I'm going to start with the barbell shrug.

What I want to do is be able to do 10 shrugs,
...
– or don’t give out – your grip is probably going to. So at some point you're likely going to stop.

When you do, you're going to work on another
...
allow them to protract. Why are we doing that?

Because the traps insert here, on the lateral
...
but I'm retracting at the same time.

The key is, we're getting more of that eccentric
...
For me, I'm using 25lbs. the 25lbs will do an overhead trap raise. So we'd basically hold the plate here, like
this, and then basically hands down, thumbs pointing down. I'm going to then go thumbs pointing up at
the top, okay? Then down, under control here, and then up.

What you want to do is squeeze your traps
...
worked here to stabilize the scapula as we lift up overhead.

You do 10 reps of the overhead raise, go back
...
I'll show you exactly how we execute it and how it looks in real time. There you go. So there you have it, guys.

There is your Sore in Six Minutes trap workout
...
and induce soreness? No.

Does soreness equate, all the time, to new
...
and get yourself out of that rut, instead of using them as your workout all the time.

Guys, if you're looking for a program that
lays out exactly what to do step by step, day by day; head to ATHLEANX. com and get our
ATHLEANX training program. We manipulate the volumes, we issue you the
workouts as we know you can handle them, and not just throw it all out there at random. All right, those are over at ATHLEANX. com.

In the meantime, I know you like the Sore
