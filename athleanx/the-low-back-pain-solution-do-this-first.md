...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=lFpx0cpmJ3w"
cover: imgs/cover.jpg
description: If you have ever had back pain or you are dealing with it right now, you know how debilitating it can be. In this video, I’m going to tell you the truth about back pain and what you really need to do to fix it permanently. All too often, you are told to rest in order to alleviate your symptoms. The
language: en
---
...
So, this video is all about back pain. More 
...
Guys, back pain is an extremely common thing that happens to all of us. Up to 90% of us 
...
your back pain, you need to be working your way through back pain.
...
In the rare instance that it is a disc related issue, I will tell you 
...
is never going to be the answer. Exercise is always going to be.
...
location of your pain might be your low back, the source is almost never the low back.
...
couple things. Number one: you can see that my feet are in contact with the ground.
...
And so remember I said that prolonged rest was the worst thing that you could do for back pain. The reason is that the long term cause of what's going on here is almost always weakness. So if 
...
going to start right now early with this exercise.

It's just a seated row. And there's a few benefits 
...
or at the gym with a cable.

But we don't load ourselves up that much here. It doesn't matter 
...
But beyond that, what are we doing from the top down? You can see that we're 
...
Moving, not resting, moving to get these things to start moving the way they're supposed 
...
into the low back, but it's driving the movement from the glutes up here.
...
engaged by having a little additional weight in our hands.

Not to mention this additional weight 
...
make sure this never returns again. So we got to get on our feet.

I mentioned the last time when 
...
All right, so now you're feeling good about the pull 
...
and it's the dead lift. It's probably got a bad rap.

It's actually the exercise you need to do if 
you have a bad back, but done after you've built that foundation and that base up. Because what it 
does is it reinforces the same thing we've just been working on here through the pull through. Right, it's letting the glutes be the main driver of hip extension. Feeding that kinetic chain, and 
more importantly, the low back muscles from the ground up. At the same time, you can see that at 
the top here, it's not just all about the lower half, right?

It's all about the ability of all 
the muscles of your back to contribute to what's ultimately happening here and being borne by the 
low back, right? Working that kinetic chain from the top down and working it from the bottom up. The fact is because you can overload this exercise to the next level and reinforce all the things 
...
have the barbell row.

And you might be thinking, Why is this above a deadlift? How is this more 
...
contributing in a more isometric way.

They're not driving this movement. You can see that they 
...
our body in a dead lift.

So that increases the demands on your low back. For all these reasons, 
...
to build to make sure that there's no slip-ups along the way.
...
best to do that for you on the days and weeks ahead.

And if you haven't done it already, guys, 
