...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=qk97w6ZmV90"
cover: imgs/cover.jpg
description: The perfect abs workout should consist of exercises for not just the six pack or rectus abdominis but other important muscles of the core as well.  That said, even that doesn’t make the ab workout complete.  In order to round out your midsection you will need to hit the obliques, transverse abdomini
language: en
---

# The PERFECT Abs Workout (Sets and Reps Included)

The perfect abs workout should consist of exercises for not just the six pack or rectus abdominis but other important muscles of the core as well.  That said, even that doesn’t make the ab workout complete.  In order to round out your midsection you will need to hit the obliques, transverse abdomini
...
But we have to include some features to make
...
You're going to find if you save your bottom
...
I'm going to include the use of just a band and a pullup bar.

So even if you're doing this at home, you're
not going to have a hard time following along. Guys, when we talk about the function, the
abs do a lot of different things. They don’t just do this. That's what a lot of people think they do. They think they just crunch.

As a matter of fact, they control motion in
...
And we can work exercises that can do that,
...
As a matter of fact, they can become main
...
When it comes to the anatomy part, sometimes
...
at is not just how easily noticeable it is, but what is the direction of the fibers? What is it attaching?

It's going up and down, north and south, attaching
...
oriented at an angle. At an oblique angle.

That's where they got the name from. The driver of this is that it has a different
...
But it does the same thing. It controls rotation in another way, again,
working in concert with the obliques on the other side to produce some really magnificent
things when it comes to rotation. But then we can look at another muscle here. That's the transverse abdominus. This one runs more like a weight belt.

Literally, around your waist. With the idea being this is driving stability. We want to take advantage of that because
...
The interdigitation – that's right, I said
...
The bottom up movement will drive this. If you look at the beginner version here,
...
That becomes a hip flexor driven movement. If we just isolate the lifting of the pelvis,
...
we'd look over here at the advanced side. This is a hanging X-Ray. The advantage of the hanging x-rays is twofold.

Number one: it's more difficult because we
...
the pelvis from the bottom up with the activation of the adductors.

So, the x-rays allow us to do that. So, either way, if you're starting to build
...
We're going to make clockwise circles and
...
We mentioned it in the beginning. We're not trying to prevent rotation here. As a matter of fact, we're not trying to do
...
Sticking with the rotational theme now, we're
...
is perform this recliner elbow to knee tuck. The main thing to focus on here is the function.

We're driving rotation here and we're driving
...
the band with the hanging pullup bar. What we want to do here is add some resistance.

Driving the band down into the side. Again, creating rotation. The idea being, no matter what you do for
...
Now we start to move on and transition away
...
when it comes to using it as an exercise that's more remedial.

If we know we can hold a plank for 2, 3, 4
...
This is a little easier than it looks because
the top down motion is going to help shorten that lever arm of the legs, in relation to
the torso. But don’t be fooled. This is not easy. But it is doable. Especially at this point in the workout.

As you see, once again, we keep building up
...
The first exercise here, if you're more of
...
If you start to see that they drift back to
...
You can see here; I'm driving a lot of rotation. Even from – you can see the pivoting of
...
Now that we've fully transitioned to the top
...
If I want to make this more difficult, all
...
you to focus on in these top down movements. The first one is how we're doing it. You will not see me doing this. I'm not sitting back with my hip flexors.

I'm not just allowing my pelvis to drop down
...
your way through every, single rep and you're not going to get anything out of it.

The second thing you want to focus on is what's
...
to want to drop down into that hip flexor cheat if you do this bracing first.

To do that, you just want to flatten your
...
Once it's there, then you pull down and forward,
...
at this point, ours is not quite there yet. We've got one more exercise.

We want to work the serratus. I talked about its involvement in integration
...
What we do is get ourselves in that plank
...
to your entire ribcage. That is important.

That is a function of core stability. So, we can work that here and at the same
...
it's that extra push. Don’t just get it out in front of you.

Push out in front, and then another 2" or
...
seconds, the fact of the matter is, you have to understand there is no such thing as 'perfect'.

We know we can have a lot of other ab exercises
...
know how much it matters, all our programs are based on that same principle. They're all available over at ATHLEANX. com.

If you're looking for more of the perfect
