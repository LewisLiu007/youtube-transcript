...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=6g57DJntRXk"
cover: imgs/cover.jpg
description: There are so many biceps exercises, but which ones should you be focusing your efforts on if you want to build bigger biceps? In this video, I’m going to give you the most popular bicep exercises ranked from worst to best and help you to determine which ones you should be doing and which you can pro
language: en
---
...
And so, with no need to have to concentrate 
...
As a physical therapist, I want to deliver those gains, but do so without 
...
selections. So that being said, let's start breaking them down from the bottom to the top. And so just like that, we start at the bottom of the barrel.

Here are the worst of the worst and 
...
A lot of people will just simply rest their arm on top of their thigh, creating 
...
the biceps aren t doing all that it can. Throw in the fact that while you may feel a 
...
for that reason, guys, the Concentration Curls gets the first in the bottom are the Worst. By the way, if you love Concentration Curls and you still want to do them, at least do them 
right.

Do me a favor and watch this video over here when this one is done, and I'll show you 
exactly how to make sure you do every time. Moving on, we have an exercise that proves 
...
abilities it has is to supinate that forearm.

If you fully pronate in order to grab this bar 
with an overhand grip, you are minimizing the contribution of the biceps to the exercise. Sure, it will be there to help the flex that elbow and bring the bar up, but as the third 
...
exercises as we work our way up to the best. And so if we confuse the right way to do the 
Concentration Curl and got confused with what muscles the Reverse Curl does, this exercise 
is just plain confused. We're talking about the Biceps Pushup.

It's just not a bicep exercise. It never is. It never will be. And for those that think, Yeah, but for calisthenics? No.

But not 
even.. ? No, not at all. Yeah, but.. Nope.

How about just a little bit? Unfortunately, 
no. I mean, even just It just doesn t.
...
It should never bear the name of a Bicep Pushup. For all these reasons, it only bears 
a big red X right through its name, and that's why it belongs here at the bottom of the list. And so, with that I nugget to break out my blue marker as we work our way up into the Better 
...
this does is it checks all the boxes in terms of bicep function.

In order to pull yourself 
...
our body, the most overlooked component of a true biceps complete contraction.

Check. What holds this exercise back, however, is simply loading it becomes a lot more difficult. When you're looking for progressive overload, this may not be the best choice. But you're 
looking for a good bodyweight bicep exercise, did I mention is better than the Bicep Pushup? Then this one is the one that you're going to want to use, and it belongs as the first with 
...
Guys, remember, you are actually strongest in the eccentric part of the lift and when you're 
...
here for a Better exercise, but not great. And so next up in the Better Category is an 
improvement on once again, an exercise in the Worst Category, those Concentration Curls. And 
this time we're looking at the Preacher Curl.

Again, it's a great exercise for building up 
...
countdown to look away. Three, two, one.

All.

Yeah, that's ugly. But I did give you a heads 
...
when you actually start to free those elbows up, better exercise options await you.

We're going to 
encounter those later in the list. But for now, the Preacher Curl just gets the blue 
circle for a Better exercise. And wrapping up the Better Category we have 
...
that portion of the rep.

However, its limitation is it doesn't have a whole hell of a lot of 
...
Either way, if you're looking to offset some of the load on 
your elbow and feel good or just want to step it up to another level here, the Cable Curl is 
one of those really solid, better exercises. And so now I get to break out my yellow marker 
...
important component of bicep function.

Of course, as we bend the elbow and curl in, we're going 
...
circle in the Better Still Category. Next up is an exercise that's unique from all 
the ones we've actually talked about so far. And it's what places it right here squarely in 
the Better Still category and we're talking about the Drag Curl.

Because this exercise is uniquely 
...
we get more of a stretch on the long head of the biceps.

Because the long head is the only one that 
...
include in our Better Still Category. And so if the Drag Curl was great at hitting the 
long head, what's our short head option that gets us to that Better Still ranking? For me, it s 
going to be the Spider Curl.

And what we get here is a better option than the Preacher Curl 
...
are going to be positioned slightly out front. And by simply dangling ourselves over an incline 
...
for helping those that can't feel that muscle connection.

Not to mention because those elbows 
...
to belong in this Better Still Category. And finally, if it's those bicep picks that you're 
...
What we've got here is an exercise with built in effectiveness by simply having to grab 
...
won't allow that because you have to keep the top of the dumbbell parallel to the ceiling. At the same time, with the hand slightly rotated in again, that alters that line of pull to really 
target that lateral long head more effectively.

I've said before what you see is what you train. If you can see a little bit more of the outside of the bicep, you're more effectively hitting 
...
arm back behind our body, we're actually going to get it into a more passively stretched position. Meaning just by sitting on the incline bench, my arm is going to fall into the proper position 
...
And it gets the first spot here in the Almost Best Category. And next we go back to the bodyweight exercises and who knew a bodyweight exercise would 
...
underhand grip on the bar and we've got shoulder flexion.

Now for those that might be saying, 
But wait, aren't you extending the shoulder from a flexed position on the way down? You have 
to understand that when you end the exercise, you are still in a flexed shoulder position. So, at peak contraction you've got all three components in place making this a great choice. The ease of accessibility here is another great option because it's easier to set up than the 
Inverted Chin Curl. And all you need to do is grab a pull up bar and throw it in your doorway.

And for those concerned about the last taking over too much of the work, we've got an easy fix. You simply increase the angle of the elbow maxing out at 90 degrees as you pull yourself up, which 
...
in the Almost Best Category. And so, with a bit of sadness and a little bit 
of a tear in my eye, I have to wrap up my Almost Best Category with one of my almost favorite 
exercises of all time, and it's the Barbell Curl.

Now, why is it not the best? There's one 
...
you have to move that weight through space all at one time, demanding a strong core.
...
I get to stick with my green marker, but this time crown it as the king of curls with the Green Star. And this time we're talking about the Alternating Standing Dumbbell Curl. By switching out that 
...
There are so many different things I can do with this exercise to take it in 
...
to wear the crown as the king of curls, for me, this is the best exercise for your biceps. Remember, guys, when it comes to building bigger biceps, though the movements may all look similar 
it's the nuances and how you perform them that makes the big difference.

Hopefully now with this 
...
Subscribe and turn on your Notifications, so you never miss a new video when we put one out. Also, if you're looking for programs step-by-step, we have them all over at Athleanx. com.
