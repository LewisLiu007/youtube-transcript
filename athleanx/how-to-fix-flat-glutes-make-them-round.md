---
title: How to Fix FLAT Glutes (MAKE THEM ROUND)
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=F8DErukW4yo"
cover: imgs/cover.jpg
description: If you want to finally wake up your glutes because they feel weak, underdeveloped, or just aren’t looking the way you want, then this is the video you need to see. I’ll walk you through some glute activation and strengthening drills that you can do every day to build bigger, stronger glutes while al
language: en
---
...
Again, working both sides. But now, let's say you've woken that up. You've got better control of the glute medius. How can you now take advantage of that to get more out of the strength training component and the exercises that do a great job of hitting both to allow for bigger glutes or more glute development? So now, separate from those activation drills, let's say you have aspirations to get a bigger ass, right?

You want the bigger, more well-developed glutes. This is how you would do it. You got to add a little bit of weight, right? And just a single dumbbell is going to allow you to do this, but it's choosing the right exercises and then doing them the right way, as is often the case. So, how you do this or one of my favorite ways to do this is with an offset reverse dumbbell lunge.

Okay? And why we go reverse number one is because it just helps to alleviate some of that pain that we get in the knee when we lunge forward. A lot of people complain about knee pain when they lunge forward. We're not going to have to worry about that because we're going to lunge backwards. Now, if you're going to lunge back, the leg that goes back is the leg that you want to have the dumbbell in.

Okay? The hand that you want to have the dumbbell in. So, if I'm going to lunge back this way, it's that left hand that's going to be holding the dumbbell. And again, how I point my torso is going to make all the difference in the world. So, usually people go straight up and down with the torso like this.

But that's going to focus more of the effort on the quads. If I want to light up the backside, I have to lean forward, right? By leaning forward, I could turn just a little bit for you. By leaning forward, I've completely shifted this load primarily to the glutes. All right?

So, down and come up. Okay, stand up. Reverse. Lean forward. Keep that low back straight.

Just tilt the entire torso forward and come up. Now, what's that side benefit? First of all, good glute max development going back and forth into hip extension here and extending the hip and squeezing through the butt on the way up. But we have that other benefit, too. Controlling the same frontal plane abduction that we were talking about in that leg swing.

Because when I go down, this dumbbell wants to pull me in this way, right? Because offset one side only. And what happens is the hip wants to slide out to that direction. The only way I can work this glute medius is to keep the hip right where it's supposed to be. All right?

So, as I go down and this wants to pull me down this way, keep this nice and tight, lean forward without that shift. Come up out of it. That little move just like this is going to be an amazing way when you strengthen both the right and the left hip to get good glute development. Now, the next thing we could do is something called an RDL, but done in a very specific way. I want to go and lean towards the floor, let the other leg come up behind me.

You might be getting a little bit of active hip extension on that side, but it's not really the focus. What you're trying to do is go down and then drive out through that down glute. Okay. So, in this position here, I'm going down to the floor and I'm going to drive out of it with good hip extension. But the same thing applies because the dumbbells in that offset hand.

It wants to pull me down. I can't let that happen. I have to keep this hip nice and stable here, straight down, pull through without it sliding out on me. This is a balance challenge as well. If you find it to be too difficult balance-wise, put this foot back and just do it as a slight kickstand position.

All right. So, if I have this back here, slight kickstand down, squeeze it through, drag the toe down, squeeze it through, and drag the toe. Just enough so that the balance is not the main issue. One more move here. We call this a frog press.

This one targets the glute medius specifically because we're gonna externally rotate the hips. Okay? So, not a regular glute bridge, but one done from this externally rotated hip position. So, when I put the dumbbell right here on my junk, right across here, and I lift up into that bridge, you can see that I'm favoring the glute medius because I've externally rotated the hips by putting the soles of my feet together and flat on the ground. This setup here will make the rest of this automatic by lifting straight up here.

Again, squeeze. You'll feel it deep into that hip, deep into the glutes, underneath that glute max. It's a great complement to the other two exercises that had a heavy involvement from the glute max. And again, you go here all the way up. Good full extension, couple sets to failure to really work on developing.

And again, you can overload this with heavier and heavier dumbbells. The idea here, guys, is the glute medius is a prime focus for all of you who are having any type of low back pain right now, any hip pain or just underdeveloped glutes. And again, if you're already suffering from back pain, guys, I have a video that helps to target that glute knee specifically and some of the trigger points that occur when weakness is there. You can find that video here. It's helped over 40 million people.

If you're looking for more glute exercises you could do, I ranked over 15 of them in this one video for you here. All right, guys. Make sure you subscribe, turn on notifications so you don't miss a video when we put one out. All right, guys. See you soon.
