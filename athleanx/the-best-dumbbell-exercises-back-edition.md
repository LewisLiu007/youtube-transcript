...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=a9_JPgwW9nw"
cover: imgs/cover.jpg
description: The best dumbbell exercises for back are based on the criteria for what you are trying to specifically train for.  In this video, as I’ve done in this entire series, I’m showing you which exercises you should be doing to develop strength, power, hypertrophy, metabolic overload, total body, correctiv
language: en
---
...
This time, for the back. But instead of giving you a mind-numbingly
...
Let's jump right into our first exercise selection
...
a whole is to add some weight to one of the more difficult exercises, in general. That is the pullup.

The pullup is one of the better back-building
...
But wrap it around the dumbbell, hang it on
...
by adding more weight to the dumbbell each time you do the exercise.

Next we move onto the power selection. We know if we're going to train for power
...
your body into extension to get those lats working.

The element of explosivity comes from the
...
we look to do the opposite of what we're doing when we have a straight or power focus.

Instead of trying to incorporate a lot of
...
to the bench instead of lying alongside it.

Why? Because it allows us to manipulate our hips. You might be thinking "Why is it important
to manipulate your hips? " Because we want to create more stretch. We want to give ourselves another opportunity
for eccentric overload and stretch on the muscle we're trying to develop.

A known stimulus for muscle hypertrophy. We can do that by dropping the hips down. You see, I simply allowed them to drop, realizing
...
you should immediately feel a lot of tension places on the lats.

You come up and complete this as you normally
...
fatigued, it doesn't mean you can't do some more eccentric work.

We know that we're stronger there. And we can by simply cheating the motion back
...
Next up is our metabolic exercise. When we're training metabolically, looking
...
This is chest supported touch row. We have a couple things to discuss here. Number one: the position on the bench. The bench is going to protect that low back. It's going to allow us to fatigue the lats
without having to worry about the fatigue of the low back posturally, that we would
get in standing.

Now, we talked about the touch row. We have these dumbbells placed out in front
...
going to require the arm travel up and ahead of us to get more of a stretch.

But additionally, those other dumbbells are
...
we protect the low back in the process and made it a much better selection.

Next, we move onto the total body exercise
option here. Obviously, to hit this criterion you've got
to work your whole body. But we have to be able to hit the lats as
well. That's what this exercise does. This is the man-maker.

With a single pair of dumbbells, we're going
...
in the process of doing a total body exercise.

Why? Because the weight is going to be determined
...
dumbbell set to do that.

So, really what's determining what dumbbells
...
to hit your lats in the process. Moving on now, we hit our corrective exercise.

You know how important the correctives are. They literally determine, I think, your longevity
...
to try and work on incorporating the W-Raise. Where does it get its name from?

It's the position of your arms in relation
...
as 'back muscles'. Namely, the rotator cuff.

We know if we can get the muscles on the backside
...
Not that there's anything wrong with that. The rear delt is a muscle in the back that's
...
to give you a lot of corrective benefits that are going to last long after this set ends.

Last, but not least, we have our miscellaneous
...
important it is. That is the low back.

For me, I want to do the bench reverse hyper. This can be a weighted exercise. For some, you may not even be able to tolerate
...
undertrained with weight.

This is giving us a chance to do that. What you want to do is lie face down on the
...
initiate with a glute squeeze.

Try to squeeze your butt as tight as you can
...
Don’t look for substitution. Don’t try to swing the weight up as hard
...
to you, depending upon what you're training for.

Remember, no matter what it is you're trying
