...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=JJAxStcNZeo"
cover: imgs/cover.jpg
description: If you want to get wider forearms you have to train the muscles in the forearm that are most responsible for their size. Often times, people fill their forearm workouts with nothing more than wrist curls and reverse wrist curls. This is just not going to cut it when it comes to building wide, muscul
language: en
---

# How to Get WIDER Forearms (WORKS EVERY TIME!)

If you want to get wider forearms you have to train the muscles in the forearm that are most responsible for their size. Often times, people fill their forearm workouts with nothing more than wrist curls and reverse wrist curls. This is just not going to cut it when it comes to building wide, muscul

So, if you want to build a wider forums, whether 
you're talking about this direction here or this direction here, the good news is I've got you 
covered today. Because there's a right way to do it and maybe a much more right way to do it. The thing you have to do first for me, though, is not make the mistake of blaming your lack of 
...
mostly just tendons. The bellies of the muscle die a lot higher up in the forearm.
...
to start by talking about how we can get more of this width here from top to bottom. Then we've got to look at the extensor side of the forearm. And for me, there's going to 
be two muscles that you want to focus on.

One is actually something you're probably not even 
...
probably doing a lot of reverse risk curls with a dumbbell. That's great. However, when I pick up this dumbbell, watch what actually happens because this is pretty 
interesting. Just by holding this dumbbell here, the muscle that pops out the most or fills the 
most space in your forearm is actually this right here.

That's the brachioradialis and that is not 
a wrist extension muscle because it doesn't even cross the wrist it ends over here on the radius. So, what we want to do is focus on flexion of the elbow when we want to build up that muscle. Now, when I add the extension part here, you can see that that muscle that you're trying to build 
...
width, you really have to focus on building up this brachioradialis.
...
and brachialis. And the more supinated we are, the more the biceps is going to want to take over. So, if we can get into a fully pronated position, then we can kind of favor more of the work 
being done by the brachioradialis, and therefore help to build it.

The problem is some of us can't 
...
themselves and you would perform it with this. Now, here's the interesting thing, the range of 
motion on the exercise matters. Why?

Once again, because of that synergy overlap between the 
brachioradialis and the brachialis. If we look at the skeleton here, we can see that as we break 
his arm, we can see that the brachialis is starts up higher inserts just past the elbow joint. Whereas the brachioradialis starts lower and starts all the way down here. Remember, it doesn't 
cross the wrist, so it has no impact on whether you extend your wrist or you don't. But what this is is important because if we want to favor more brachioradialis, then 
we want to decrease that range of motion.

Why? If I was going to try to pull this plate up, 
...
it's up enough, well, pulling from back here is very easy to keep that force going.

So, 
if we can abbreviate that range of motion, we're going to have that same capability. Now, the way we do this is we just start the bar at our waist, and we turn this into sort of a 
...
doing more of the work and all we do is lift it straight up.

Okay, getting all that elbow flexion 
...
be able to overload it. So, of course, I don't want to just do that lighter exercise.

I do want 
to do heavier hammer curls. Just understand in this position here, there's more work being done 
by the biceps and of course the brachialis because we're getting away from full pronation. But you still want to have that one, two combination. Now, what about the other side? This 
side here, to build this up, this width.

Here's where a lot of people make a big mistake. Again, 
they focus on all kinds of risk curls. Again, doing it from this position this time. Good. But realize that there's a bigger chunk of these muscles responsible for something different, and 
it's going to be the action of the fingers.

So, if you look here, this is what happens when I just 
...
muscles up to the full capacity. So how can we combine them once again in the same 
way you come right here, you do this exercise.

You grab a cable, or if you're at home, you use 
...
looking at before. Pull down and then pull into wrist flexion.

So, all the way up into the fingers 
...
as you're able to handle more. Now, for those that are asking. But Jeff, didn't 
you say one time that letting it drift into the distal fingers can overload that muscle to the 
point where it causes pain in the medial elbow?
...
this muscle that it can't handle it. Ironically, as you start to strengthen that 
...
just a bit, you're going to curl and then curl.

Make sure you work in the resistance through 
the hand all the way down into the forearm. Guys, if you're looking for more workouts, 
...
athleanx. com. If you like the video guys leave your comments and thumbs up.
