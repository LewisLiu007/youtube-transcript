...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=4EkKhkSNjWY"
cover: imgs/cover.jpg
description: The perfect forearm workout should consist of exercises for not just wrist extension and flexion but other important forearm actions as well.  That said, even that doesn’t make the forearm workout complete.  In order to round out your forearms with a well rounded workout you need to fill in the gaps
language: en
---

# The PERFECT Forearm Workout (Sets and Reps Included)

The perfect forearm workout should consist of exercises for not just wrist extension and flexion but other important forearm actions as well.  That said, even that doesn’t make the forearm workout complete.  In order to round out your forearms with a well rounded workout you need to fill in the gaps

What's up, guys? Jeff Cavaliere, ATHLEANX. com. Today we’re talking about the forearms and
we’re going to construct the perfect forearm workout. As always, we’re using science and anatomy
to backup what we do.

If you want to put the science back into strength
...
Then, of course, you’ve got to add to them. Why? Because there are different functions here
...
– you can see there are different areas of the forearm that work to create that.

Same thing here. If I were to go in the opposite direction,
...
when we have to include all of them?

I’m going to make it simple for you, guys. I’m going to include all the things we need
...
we’re going to start with these wrist curls
...
fatigue that our bodies are masters of compensation.

They’re going to find a way to perform the
...
up to do the job the forearms can’t do.

You might say to yourself “Well, I’ve
...
here as well. So, I’m on the right track.

Guys, you might be on the right track, but
...
video on how that is the number one cause of medial elbow pain that we deal with.

It’s how we grip the bar, it’s how we
...
the sinking of the bar into these distal fingers here.

That’s going to overload an stress that
...
a better way to do this. And I do this right here with a cable machine.

You can immediately see I’ve bent my elbow. I’ve taken the biceps out of this. I’m now pushing away. The other thing that’s happening here is,
...
either. You can use a band.

The fact is, you’ll get a more intense contraction
...
The forearms also very much require to have
...
going to end with the ultimate test of muscle endurance in our forearms, the arm hang.

But for now, work your carries in between
...
this isn’t necessarily the best way to do it. There’s a reason for that.

We should know by now, when we look at the
...
you guys, I’m extending this wrist back on the right side to come up.

You can see that even at its peak into full
...
style because I have another opportunity here.

If I’m in this standing position I could
...
Three seconds of rolls, and then three curls. I try to work my way up to a ladder as high
...
For some of you guys, you’ve never even
...
like we talked about. It’s also being able to bend this way.

So, when we come toward the radius, the top
...
And you’ve probably seen people recommend
things you can do for this before. Like, using a sledgehammer. And they hold the sledgehammer down at their
side to work on radial deviation. They lift the weighted part up in this way. Now what we do is work on the way back.

For ulnar deviation we flip the sledgehammer
...
Take one handle and stand up nice, and close. Put your hand down at your side. Now, because you can torque your hand off
from the bottom here with a rope, we’re going to go down like that. So, we go from neutral, or a little bit of
radial deviation, down into ulnar deviation. Just like that.

Nice, and slow, and controlled. You do a set of these, you walk around the
...
Now, we’re going to work radial deviations. From here we’re going to push with the pinky
...
the ground and then you want to end with it facing out in front of you.

Again, guys, we work both sides. We’re going to walk around the gym, as always,
with another carry, come back, and move onto the next exercise. Now, supination and pronation. Guys, this is not the way to do it. You see people do this all the time.

You’re actually falling into pronation here
...
here what I do is hold the rope this way, and now I’m going to use it again this way.

I’m pushing my fingers here into the rope
...
and then of course, walk around the gym with your carry.

Now you come back and go the other way. If I want to do supination here, what I do
...
supinator. But it’s not the only one.

We’ve got a supinator muscle in our forearm
...
extra resistance to add size to your forearms.

So, we want to make sure we do that. All right, guys. Almost done, but we now want to work those
...
We’re talking about my forearm, Jeff. ” You saw in the very beginning here, the activation
...
those old rippers anymore.

” Yeah, you do. You can take one of those collars from the
...
But to integrate that, what I like to do is,
...
and then I go and move my wrist into extension, and down into flexion. Into extension, and flexion. Extension, and flexion.

Flexion, being able to still hold some tension
...
and generate force, even in a shortened stated. So, I have a little bit of tension.

I go back and forth into extension at the
...
nail in this coffin, guys.

We’re doing the arm hang. You guys know how much of a fan I am of the
dead arm hang. What we’re doing here is trying to hold
on for as long as we can. Now, in a good situation, fresh, 1:40 is a
good time. It’s a good, average time.

What I’m looking for here is, can you hold
...
fingers because of the stress it puts on the elbow. Really squeeze.

Really hold. Activate the forearms. Try to gut it out for one, final minute at
the end. So, guys, there you have. There is the perfect forearm workout.

As you can see here, all the sets, all the
...
sure we’re hitting everything when you’re supposed to; all our programs do that.

They’re over at ATHLEANX. com. In the meantime, if you liked this series
...
and I’ll do my best to do that for you in the days and weeks ahead. All right, guys.
