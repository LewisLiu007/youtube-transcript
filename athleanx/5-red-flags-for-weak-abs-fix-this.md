...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=PSROJpBIZ4w"
cover: imgs/cover.jpg
description: It doesn’t matter whether you have visible abs or not, the strength of your core is not something that can be assessed by how they look in a mirror.  In this video, I’m going to show you 5 specific things you can look for that will act as red flags to alert you to an ab weakness that you are going t
language: en
---
...
away where you’ve got a weakness, and more importantly, what you can do to fix it.

We’re going to knock them off one by one. Let’s get going. The first red flag that you’re dealing with
...
That’s wrong. Same thing here. If I was on the ground, doing the scissor. Yes, this is an isometric hip flexor exercise
...
abdominals. What you need to do is flip that around.

You have to engage the abdominals. Up here on the hanging leg raise you curl
the pelvis. You curl the pelvis. If the pelvis is curling and flexing, we know
the abdominals are doing their job because that’s what they do. They flex the pelvis.

We know that the hip flexors, on the other
...
then allows the hip flexors to go along for the ride.

Guys, it’s a very important point. Do not allow, on any ab exercise, for you
...
you do your ab exercises.

That’s something you do not want to tolerate,
...
the following: first, do you need someone to anchor your feet down?

Are you sticking your feet under something
...
back, you have weak abs. That’s something you cannot allow.

The third thing is: if, on the way down, you
...
in the beginning. That is a dominance of the hip flexors. The hip flexors taking over. So, here’s what we want to do.

We want to make sure that we don’t allow
...
So now I’m not getting that pull on the
...
off the ground, one segment at a time.

That’s going to guarantee that you’re
...
lumbar spine, likely creating the pain that you’re feeling.

However, if we can get the abs to activate
...
this slowed descent back down to the ground. You’ve got to have that.

You’ve got to have your abs driving first. You can’t let your hip flexors dominate. The next red flag is going to reveal itself
...
To clean up the bar path. What we’re not looking for here is dramatic
...
each of the exercises I just named.

The next time you perform them try to actively
...
It tells me that unless you’re heavily focused
...
As a matter of fact, turning sideways and
looking in the mirror. If you see this distended lower belly here,
you’re likely suffering from a weakness that you need to address. This is a major red flag. This is not what I want. I want you to be here.

Not here. But here. You’re probably saying “What’s the main
difference there? All you did was contract? ” Yes, you’re right.

But what I did was contract the transverse
...
belt would, in terms of its orientation of the fibers. It does the same thing a weight belt does.

As it contracts it cinches down. Here, contracts, it cinches down. It creates that smallness of the waist. It creates that tightness, inherently, by
performing like a weight belt would. Now, you want to make sure you have the ability
to do that.

You need to make sure you can do it by practicing
...
Again, thinking about it like a weight belt
...
of reps you do, but you’re increasing the number of quality reps you do.

Over time, the more strength you get in the
...
The first one is pretty easy, as Jesse is
going to demonstrate. All I want him to do is be able to get off
the floor. I want you to be able to do the same thing. How do you guys think you did? He’s pretty happy with himself.

But as you can see, I’m not because Jesse
...
Now, you can have strong abs and do this test. You will still feel your abs working to get
...
Next you want to test each of the planes individually. The first one up is the frontal plane. Can you prevent motion side to side? The easiest way to test that is with a suitcase
...
In other words, can you walk, dynamically
...
we need to be able to prevent motion. Not just in this plane, but all three. We have additional tests coming up now.

If this is a problem for you, it is a red
...
is your anti-extension stability?

What is your ability to contract through the
...
as your body can get.

Especially as we apply this to athletes and
...
If you’re good, you’ve got one more to
...
Step away with your hands close to your chest. Now extend your arms out away from your body. All the way, as straight as you can make them. You’re increasing the moment arm, you’re
increasing the weight, you’re increasing the demand of the core. You’re trying, at all costs, to prevent
rotating even an inch back toward the machine itself.

You want to make sure you can hold this position
...
It’s more important that you see them and
...
their strength is from the inside out that matters the most.

If you’re looking for programs that help
...
please do so, and turn on your notifications.

You now have a chance to win some free programs
