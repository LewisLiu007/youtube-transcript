...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=cxn0l7ejTbc"
cover: imgs/cover.jpg
description: "In today’s video we look at the best dumbbell exercises for shoulders. We’re going to focus on several areas of training: from strength, to power as well as hypertrophy and a few others you’d expect."
language: en
---
...
that you can do with just a pair of dumbbells.

Now, I have to qualify a couple of things. There’s no debating here. What I mean by that is, this arose out of
...
best exercises would be if you could only use a pair of dumbbells.

Now, a lot of us are training in gyms, we
...
got to deliver the goods here on why I did that.

But the one thing I said to him was that you’ve
...
and we’re going to start right now with strength.

Right off the bat when going for strength,
...
think we need to abandon the movement.

The movement is still going to be the basic
...
the legs out of the exercise by sitting down.

You wind up driving more into your knees and
...
The great thing about this exercise is it
...
this hand and a 55 here.

That’s a 10lb overall increase on the double
overhead press. So just keep that in mind. If you have the option for the barbell, go
for it. But this is about dumbbells. Use that standing press, don’t sit down.

Next up, if we’re going to talk about strength,
...
times jammers are not part of that.

Even if you have this additional implement
...
I’ve got to make a choice that’s dumbbell
...
your legs to drive from the ground up. It’s an athletic, ground-based movement.

But please do it right. You’ve got to make sure you’re not just
bending your knees, but you’re properly loading the hips. If you want to apply force and strength to
a movement and speed, you want to utilize the biggest muscles in your body. Those are around your hips. So, stick your ass out.

Hinge at the hips. Utilize those big muscles. Drive up overhead. Keep your reps sub-failure here to make sure
you’re maximizing your power output and go for it, guys. A great option here when you’re looking
to use dumbbells and developing more power.

So, we know there’s more than one way to
...
one, is going to be the utilization of a side-lateral raise.

But we’re going to do it in a cheat lateral
...
That’s a great stimulus for overall muscle
...
and then apply a strict form to it.

Go from my cheat approach to it, to a stricter
...
Really go for that good contraction at the
...
we’re trying to create muscle hypertrophy is to apply a whole different technique. That is metabolic stress.

Metabolic training. What we do here is, this is where we talk
...
What I do is keep my elbow locked into a 90-degree
...
nothing to do with an upright row.

The positioning of my hands in relation to
...
You’re going to do that all the way until
...
with a plate, but there’s no reason why you can’t do this now with a single dumbbell. You take it, once again, to failure.

By now your shoulders should feel like they’re
...
these things repping out.

But as soon as you’re done here, then you’ve
...
that you’re looking for because you’re very short on time. You’re trying to train on the overhead press.

You’re trying to train a vertical pressing
motion, but you don’t have a lot of time. You want to kill a few birds with one stone. Here’s what I’ve got for you. You might be thinking “Barbell thruster”. I would agree.

It’s a great exercise if you have a barbell
...
dumbbell off the ground.

I don’t have to stop or limit myself at
...
take the dumbbell all the way to the ground, as opposed to cutting it halfway.

Mention the work ‘corrective’ and as a
...
turn that into an additional component here. That is the prone press.

What we do is, we have to get our arms off
...
can involve the lower traps I’ve talked a lot about on this channel.

We’re forcing the lower traps to stabilize
as our arms go up overhead. Guess what, guys? They’re going to be trying to do that job
when they get back to the heavy overhead press as well. They’re important muscles. I say it all the time, guys.

All muscles matter. You need to figure out a way to do that. It should look very similar to another exercise
I’ve done. Take a guess. It’s the face pull with the overhead press
that we’ve added in recent videos.

You can see the similarities between the movement. The fact is, if I don’t have access to a
...
I thought did just that. It utilized dumbbells.

That is the rear delt row. The main benefit here is, when you want to
...
that and it will do an even better job. We call this one the Urlacher.

I have to open up my chest, externally rotate
...
would probably go with the rear delt row.

However, if you have one opportunity, I would
...
thrown in, or even some extra machines to justify my selections. Now, I wouldn’t call that a debate.

I think I did well in sticking to the rules
...
and with it, the exercise selections as well.

You’re going to get head to ATHLEANX. com
...
and turn on your notifications so you never miss a video when we do on.
