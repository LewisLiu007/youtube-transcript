...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=7bo3RaOEL8g"
cover: imgs/cover.jpg
description: "In today’s video we look at the best dumbbell exercises for chest. We’re going to focus on several areas of training: from strength, to power as well as hypertrophy and a few others you’d expect along with the best way to train adduction of the chest muscles."
language: en
---
...
What's up, guys? Jeff Cavaliere, ATHLEANX. com. Today I’m going to talk about the best exercises
for your chest. However, there’s a catch.

That is, we can only use this. Some dumbbells. I realize there are some exercise options
...
Now, we’ve covered other videos in this
...
that we have when we’re strapped with dumbbells as our only implement.

But don’t worry, guys. I’ve got you covered there as well. So, let’s get it started, guys. We’re going to break it down, one by one,
right here. First, with strength.

So, we kick it all off with strength, the
...
variation of a bench-press, I want to show you something else.

Here’s the weighted dip. It’s an exercise I like to use for progressively
...
more and making sure I keep my shoulder blades down, and back. Now, what happens when we make the substitution.

If I go from a barbell bench to a dumbbell
...
bench-press. Let’s reevaluate that dip.

I believe there’s a great opportunity here. We can take the weight that we load up here
...
and through the handle, around the dumbbell, and then to itself.

Now you’ve got a perfectly weighted dip
...
So, the goal of these strength exercise selections
...
There’s a key factor going on here that
...
their back and allow us to get back in the position to perform the next rep.

However, we can take something very similar
...
That makes you have to push off the ground
...
You push your body away from the ground with
...
force and speed with which you push, and I promise you the best gains from this exercise. Now we move onto hypertrophy. Trying to build bigger muscles.

Look, you’ve probably heard at some point
...
This one right here is the eccentric floor
...
The great thing is though, because we know
...
Get to the top and overload, and lower slowly
...
But the important factor here is that you
...
To do this we want to revel in the burn. Find the burn and then figure out a way to
revel in it, swim in it, stay there for as long as possible. That’s what creates the spark for protein
synthesis. How do we do it? Well, we perform this ladder style.

Perform a single repetition of the bench-press
...
soon, you’re going to lose the benefits of this training.

Again, I mentioned when it comes to metabolic
...
Especially if you look at it in a different
...
It’s not about the weight we’re using. It’s about the requirements of our body
...
We’re doing that here with the bench press-up. I’m trying to get the dumbbells up overhead
...
If I want to take it to another level and
...
The corrective exercises, just because they’re
...
I only want to develop my pec major. ” Guys, your pec minor is a very important muscle
...
that’s not something that’s very desirable.

So, what we do is position ourselves on a
...
side, and allow the dumbbells to sink lower than the elbow. That creates external rotation at the shoulder.

Yes, once again, I’ve used that word ‘external
...
But you’ll find that it really starts to
...
To take our arm fully across midline. We realize that the main exercises we use,
...
of our body. You might think “The chest fly. He’s going to go back to the fly again.

” Well, I already said I don’t like the fly
...
resistance. So, we have some other options. The first of which is this.

This is called the dumbbell UCV raise. The idea here is to get that arm from the
...
as we always talk about here, we can get good chest activation.

As a bonus, upper chest activation by bringing
...
full chest contraction, by virtue of getting to full adduction in the exercise. We have another option here, too.

We can take a low approach. The low approach is holding the dumbbell down
...
of the chest in the process. So, there you go, guys.

There are the best dumbbell exercises you
...
for and get you there the fastest, and safest way possible. All our programs are available over at ATHLEANX.

com. If you like this series leave your comments
...
series, when they’re published. All right, guys.
