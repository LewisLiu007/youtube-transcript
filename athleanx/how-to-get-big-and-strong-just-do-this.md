...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=-hYld_0TT_4"
cover: imgs/cover.jpg
description: If you want to get big and strong you must do one thing in your workouts. You have to remember to make progressive overload the guiding principle of your training. You simply cannot force your body to build muscle if you are keeping the status quo on the effort you are putting into your workouts. In
language: en
---
...
It's actually really, really simple. There's only 
way to do it, and I suggest you go talk to this guy. Listen, dude, I got some goodies in here 
right here for you. This is what I use. I got some farm school grade HDH low dose.
...
to what it is that you're doing. And, guys, that's what I want to make sure I do here for you today. Because it's as simple as two words-- progressive overload-- but how we define that and the ways 
we get there is what matters. And a lot of people will make you believe that the only way to 
progressively overload and get stronger and bigger is to just simply add weight to the bar.
...
that they are different. Creating muscle growth can take us down different paths.
...
that there might be different ways to get to each of them more efficiently.
...
adding more weight to the exercise that you're performing.

So if it's the curl, increasing the 
...
itself also applies here to our compound lift.

Right, simply adding more weight to the end of 
...
a five-rep, even higher rep levels.

As you're able to do more weight at those levels 
...
That being said, if we're going to take an example like this where we have five sets 
...
that being said, guys, I got more to say on that in point number three.

And that point is in the 
...
In other words, look at this curl. If you look like this when you're curling, I'm 
...
to do is you need to start pushing more. You need to start putting more effort to what you do.
...
See, if you took protocol one here, you just did a five by three, at a certain level 
...
However, your output was the same. For you create that same output in a shorter 
...
It's simply to increase the range in motion of 
...
it back is doing nothing to increase the demand on the triceps.

If anything, it's actually just 
...
to the top, every single repetition has now become one and a half.

There is more work being done on 
...
That gives us a displacement of that bar. If I simply stand on top of a 
...
10% or more to perform the same exercise. That is a form of increased overload.
...
itself provides a level of resistance that's toughest in the middle of the exercise.
...
progressive overload. We can also do the same thing here with a deadlift.

If I took chains and I 
...
at which you perform your lift.

Pacing can be something incredibly effective for creating 
overload. Look, if I told you to do an air squat, you'd probably say, That's not really hard at all. But if I told you to do a wall sit and stay there, how long could you actually sit there? It's going 
...
We could do a pause deadlift. You rip that thing off the floor, but you stop 
...
If I took that dumbbell curl, and instead of doing it one arm at a time where 
...
and go deadlifts, which will look this, or a regular deadlift.

Now, the touch and go 
...
Either way, if you were used to doing touch and go deadlifts, 
...
our training to actually make it more fun.

If you're looking for ways to train, guys, and do 
...
want me to cover. I'll do my best to do that for you.

And if you haven't done so, guys, please 
