...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=3h1TVVwXabc"
cover: imgs/cover.jpg
description: If your deadlift form just doesn’t look the way it should, you need to watch this important video. There are 5 red flags that can undermine every deadlift and prevent it from being one of your strongest lifts, that are going to be covered. In general, those that struggle with deadlifts usually do so
language: en
---
...
What s up guys, Jeff Cavaliere, athleanx. com. Jesse Lacio, athleanx. com. You could stay down here, I'm a little bit more 
comfortable down here with you down here.

Oh, the shorts? Yeah. So today we're going to talk about the deadlift and maybe your deadlift doesn't look 
this bad, but when you do it, you've recognized the fact that there's something wrong here, right? Either it doesn't look the way it's supposed to, or you're getting stuck at some point in the lift. So what I've done for you today as I put together five red flags that are going to define for you 
the muscle weakness that is causing the problem that you're having right now.
...
need to start where we always do, and that is With a Jesse intro. Run it. No, no, no, no.
...
rest and still has an eight pack. Listen, two things, number one, 
you're insufferable. And number two, I got to give you props, that was 
actually a really good lift. Thank you, I appreciate it.

I 
owe a lot to your coaching. Well, thank you. Can we get 
back to the video now? I guess. So, we have to start with guys the ability to actually hold on to the bar and 
...
the benefits of the extra added grip strength, you can simply do a Weighted Hang.
...
aspect of any workout program you're on. So let's say the grip is good, but now you 
...
and your other parts of your workout. And for that, we're talking about a Front Squat. We know the Front Squat gives us that preferential ability to hit the quads a little bit more so than 
the glutes in the traditional squat.

We also have a Bulgarian Split Squat, which does not only a 
...
because in order to break the bar off the ground, you have to be stable in the first place. And that all comes from up here.

And that is by having strong lats and a strong core. Because 
...
That bar wants to drift away, and you have to have that isometric strength in 
place. But whatever you do, make sure you're doing some version of the Straight Arm Push Down. The second thing is the abs the core, and that also needs to be tight and what 
...
torso to be able to maintain an upright posture.

And though you're doing a bilateral balanced 
movement here on the deadlift, you still want to have the ability to keep a rigid, tight 
torso throughout the entire lift. If you want, you can do it overhead variation as well. With the arms up overhead, you're introducing a bigger challenge because of the momentum arm 
...
bar going off the ground in the first place. So let's say you can get the bar off the 
floor, but then you struggle at that point when I'm talking about is from here to here 
to and through the knee, not lockout out, but just in that area from here to here.
...
lot of the same muscle responsibilities in terms of the hamstring activation.
...
in their participation in the movement. And of course, we have to dynamically work the 
...
We have those stabilizers that have to be addressed to and for that, once 
...
That's going to kick in next. So they're succumbing to that extra weight and load. You 
have to strengthen this as much as you can, and that Strait Arm Push Down will do just that. But when it comes to the traps, we can work our way from top to bottom. The heavy shrug is a 
great exercise for building up the strength of your upper traps and for supporting that bar and 
the weight of that load as you start to lift it.

The middle traps are going to respond best to 
...
neutral or slightly extended if possible. And of course, we can work those lower traps with 
...
Because again, you'll see it even as people start to approach those really extreme ends 
...
that to and through portion of the deadlift. And that brings us to red flag number four, 
the inability to lock out the lift. And it's the most frustrating part of a deadlift because 
you've done all the hard work, you've just got to get those hips all the way through.
...
that final portion of the lift. But what can you do?

Well we've got to make sure that we're working 
...
allowing us to use the glutes as the main driver through that final stage of hip extension. And we can maintain those hinge mechanics, but make the exercise a lot more explosive with 
something like The Swing. You're just going to want to make sure that you use heavy enough weight 
here.

So you're not making this a conditioning focus exercise, but one that's going to have 
...
the deadlift at that lower portion of the lift. But if we simply allow that to carry up an extra 
...
Well, that looks comfortable. Well, it certainly is. All right. So let's say that you have everything 
in place. You've got a strong grip.

You can rip that bar off the floor. You've got the strength to 
...
the exercise right every single time, you're going to want to watch that video over here. And of course, as always guys if you re looking for a step-by-step plan to build your best body 
while putting the science back in strength, you can find them all over at athleanx.

com. Make sure you click Subscribe and turn on your notifications, so you never miss a new 
