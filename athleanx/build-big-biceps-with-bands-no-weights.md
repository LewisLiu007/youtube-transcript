...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=G-rS3GFslts"
cover: imgs/cover.jpg
description: If you want to build big biceps with bands and did not think it was possible, then this is the video for you. Here, I’m going to show you the best ways to build bigger biceps using just resistance bands and no weights. In times of gym closures and an increase in the number of people doing home bicep
language: en
---
...
What's up guys, Jeff Cavaliere, Athleanx. com. Today we continue our popular training with Band Series, this time how to build bigger biceps when 
...
to building bigger biceps with just bands. So, I mentioned a whole bunch of curl variations, 
...
be utilizing chin ups in some way, shape or form.

And the band comes in to actually make that job 
...
chips and a much heavier, more overloaded fashion.

Either way, guys, you can't get around the fact 
that the chin up is one of the basic foundational moves for building bigger biceps and the 
bands make your job that much easier. And that brings us now to the curling portion of 
...
short head that you see when I do this.

And we have the outside long head that you see from 
...
make sure that I'm resisting supination and not just flexion of the elbow.
...
going to get more of the activity. Let's stick with that long head now for a second, 
because there's another way we can actually influence the activation of that head of the 
biceps.

And that is by placing a stretch on it before every single repetition. She might 
...
At this point, all we're going to do is lift our hands straight up to the ceiling, making 
...
legendary games, if you remember to include it. So, one of the nice advantages that comes from 
...
and that's what we get here at the Lip Buster.

And by getting in this position, you can see that 
...
ten great choices for banded bicep exercises. Speaking of feeling a strong biceps contraction, 
...
again how to wrap the bands in the first place to create a line of resistance we're looking for. So, you can see I step into the band this way and by positioning it around my hands now I'm getting 
...
or get rid of the exercise in the process. So, one of the best parts about the Preacher Curl 
...
body like we talked about.

The other thing is by locking it in place, we eliminate a lot of the 
...
other than the band I'm holding in my hand. Now no list of "bicep" exercises would be complete 
without considering the brachialis.

Yes, it's a different muscle, but functionally it's going 
...
also want to pull the band up and across my body.

When I do this properly, I'm actually in 
...
going to know you're doing it right now. There's one downside to the Crossbody Hammer 
...
do that by doubling up the band.

We give this offset grip. that's important because the more 
...
take advantage of that fact and do so. And with that you've now got ten exercises with 
bands that you can use to build bigger biceps without compromise. And talking about bands, 
guys, a lot of you asked me where we get ours.

I actually have my own high-quality bands available 
over at athleanx. com, Athlean Elast-X. If you're looking for programs, guys, we have all 
...
make sure you leave a comment and thumbs up below.
