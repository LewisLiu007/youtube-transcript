...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=RjexvOAsVtI"
cover: imgs/cover.jpg
description: The perfect leg workout must consist of compound exercises for the quads, glutes and hamstrings while not overlooking the smaller muscles of the hips and our ability to train in all three planes.  In this leg workout, you will find that we overlook no component of upper leg training and get you trai
language: en
---

# The PERFECT Leg Workout (Sets and Reps Included)

The perfect leg workout must consist of compound exercises for the quads, glutes and hamstrings while not overlooking the smaller muscles of the hips and our ability to train in all three planes.  In this leg workout, you will find that we overlook no component of upper leg training and get you trai

What's up, guys? Jeff Cavaliere, ATHLEANX. com. Breaking out the muscle markers, yet again,
to continue the perfect workout series. This time, hitting the legs.

Guys, as always in our perfect workout series,
...
do, and why would we do it? That’s what’s most important here. Why are we selecting what we’re selecting?

To do that we always start with the anatomy
...
The one that is seen here is called the rectus
...
knee joint, and they are able to extend that knee.

Now, whether that means we’re sitting down
...
components to this as well. We have something that’s a little more medial.

We have something that’s a more lateral. The biceps femoris on the outside, the semitendinosus
...
on just the sagittal plane.

I know we like to walk and move in this direction,
...
sure we’re hitting the hips, the glutes, the hamstrings, and the quads.

By the way, guys, there will be no muscle
markers for the glutes. I know Jesse volunteered. He's been in these videos naked before. It ain’t going to happen, guys. Use your imagination.

I’m going to show you why and how it is
...
this thing off with a good, compound exercise. The best, when it comes to training the legs.

That is the squat. What we do here with the squat is work our
...
is going to be, then use about 20% less than what you’re working weight is going to be.

Just do a few reps with each weight. Enough to – we call it ‘grease the groove’. To prepare yourself for the working sets. What I like to do individually when it comes
to the squat is something we call a ‘touchup set’. With a touchup set we’re trying to overreach
with 10% of what we’re going to do in our first working set, to our five-rep max.

What we do is a box squat. The box squat will allow us to get down there,
...
up, then start your working sets. What does that do, neurologically?

That overreach allows us to feel more ready
...
Training your legs to higher reps is something
...
from the bar in between sets for about 30 seconds.

You’re going to rest about three minutes
...
and hamstrings in one, powerful movement.

What this exercise does is allows us to load
...
to load it with a lot of weight like you can a barbell hip thrust.

What we do is, first and foremost, if you
...
Then allow the hamstrings to assist. A lot of us do not have good control over
...
initiating with the glutes, and then squeezing with the hamstrings.

We can do that with a lighter weight that
...
yourself appropriately to do that.

To do that you might have to use an assisted
...
to the knee flexion of the hamstrings in the barbell hip thrust.

So, you’re going to feel this more directly
...
as you go from your first set to your last.

But I will say this: because of the fact that
...
As I’ve said, most people overlook that
...
the angle of our torso on each repetition.

So, if I were to drop straight down, I know
...
So, if I’m doing 12, I have 6 done straight
...
Number one: you should always try to speed
...
knee, particularly in landing situations.

So, what we can do is help that. We can try to train that more effectively
...
That teardrop vastus medialis. That’s not true, guys. You can’t isolate that area of your quads. However, what you can do is influence its
ability to contract fully, by making sure you go into full extension. What we can do here is do that, not having
to jump on a leg extension machine to do it.

I prefer closed chain environments, where
...
It’s pulling my knee forward. When I get up from that drop lunge and I come
...
a joint. Take it through its full range of motion.

Do two to three sets with a 10 to 12 rep max
...
and outsides of our legs as well.

There’s where the adductors come in. This exercise is an incredible way to do this. It’s a dumbbell goblet adductor lunge. What we’re doing is performing a side lunge
but look what I’m performing it on. Some sort of a slick surface.

Here I have a slick board. You can do this on a floor, on a hardwood
...
That’s what is driving you up. You’re almost squeezing your legs together
...
these muscles quite frequently.

Finally, if we want to burn this thing out,
...
comes in really, really well. You’re going to hate me for it. I promise you.

But what you do is take a band, anchor it
...
Three steps out to the right, three steps
...
you’re burning like hell. Why is that?

Because these muscles are chronically weak. Make sure you add at least one of these. If you want to be psychotic you could add
a second round of this as well, but make sure you don to overlook this. It’s a key aspect of completing the perfect
leg workout. There you have it, guys.

Another perfect workout in the books. As you can see here, all sets, and all the
...
going to feel things you’ve never felt before.

You’re going to train like an athlete, you’re
...
our programs. They’re available over at ATHLEANX. com.

If you’ve found the video helpful make sure
