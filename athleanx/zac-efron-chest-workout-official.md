...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=aL_8v_cGdCc"
cover: imgs/cover.jpg
description: "Get jacked like Zac - http://athleanx.com/x/key-to-size Subscribe to this channel here - http://bit.ly/2b0coMW"
language: en
---

# Zac Efron Chest Workout (OFFICIAL)

Get jacked like Zac - http://athleanx.com/x/key-to-size Subscribe to this channel here - http://bit.ly/2b0coMW

What's up, guys? Jeff Cavaliere, ATHLEANX. com. We're back at it again. Zac Efron.

You see, last year I covered Zac Efron's workout,
...
confront all of the comments that were coming in on the first video.

But a year later, the movie is actually finally
...
and we've talked about how Zac does a push workout. Chest, shoulders, and triceps. I like push/pull and legs as a workout sequencing.

It's one of the sequences we use in ATHLEANX. However, there are some issues here and I
...
Now, when I look at a workout the first thing
...
or the shoulder exercise. Floor press here, is chest. Pushup, chest.
...
Single arm curl, bicep. Now, bicep? We'll get to that in a second. There's one tricep exercise here and I'm going
to argue that it's not even really the one you should be doing if you only have one opportunity
to do a tricep exercise. But we'll get back to that.

If we look at the exercise combo number one,
...
can allow us to get more work being done by the chest when it's time to get to the chest.

So you should immediately see that you can
...
Why are we including the legs in this exercise? If the argument is that we're doing it because
...
that's not really what we're doing here, trying to incorporate multiple muscle groups. What is the point of that?

What we could do instead is, if you want to
...
shoulders with lighter weights that I'll link here, too. Lots of stuff to link to here, guys. Just watch it. There's a better way to do this.

You can actually, on a front raise here, you
...
delt to do the work, but not had to fatigue your legs in the process. The cross-body cable raise is a good exercises.

Again, we could do these very strict, we could
...
we see that they're doing an incline dumbbell press.

You see, normally the floor is used as a safety
...
go back to a regular dumbbell incline bench press.

So what I would do here instead is, I would
...
move it down to the four spot.

What I'd do here instead is move the dumbbell
...
going to need for the shoulders.
...
cable straight ahead press that you see me doing.

Again, we drop down, a little bit of overkill
...
hands and control out the set.

However, I like the idea of including explosive
...
be doing? Definitely not.

If you have one opportunity in this whole
...
– not with a single arm curl – where does the bicep play into this push workout? Again, it could even be a typo.

But the fact is, this doesn’t – especially,
...
Zac prior to doing the workout and constructing the workout.

Even the sequencing and everything else about
...
another thing that was really disturbing?

Do you know how many of these exercises internally
rotate the shoulder? Every, single one of them! You want to know how many of these exercises
externally rotate the shoulder? Zero. There's not a single repetition done.

And this was the whole plan. This workout was repeated over, and over,
...
makes a workout a workout.

It's not just the exercises. It's how you put them together that makes
a workout a workout, and most of all, makes it effective. I've done that with our ATHLEANX training
program. You can get that over at ATHLEANX. com.

In the meantime, you've got a lot of videos
...
because I think you're going to find them very, very helpful. All right, guys. I'll be back here again soon.

Let me know what you want me to cover here,
