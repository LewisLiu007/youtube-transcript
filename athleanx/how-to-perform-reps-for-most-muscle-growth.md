...
That was all momentum. That was not a muscle you were trying to build there. That was momentum. And momentum dictated that there really wasn't a lot of muscular effort going on on that. So therefore, whatever that results in is not going to be what you were looking for.

Same token. Do we go super light? If I went super light here, okay? And I grabbed these and I went right for the lats. It doesn't matter how hard I'm squeezing here in that contracted position.

And even if I wanted to perform a one and a half rep and come up and then come back down again, or if I wanted to go to the top and then get a good stretch and then come down halfway and go back and get another stretch because we know those are good. Doesn't matter. the weight isn't enough. The amount of tension on that weight doesn't even qualify, right? It doesn't even register on this line here because it's just too little.

And again, no matter how much I'm doing here, unless I did extremely high rep counts. Nothing is going to overcome the fact that there just wasn't enough on that bar to begin with. So the point is when you're trying to figure out which is best, it really depends on a your goal being strength or hypertrophy and from there the exercise that you're doing because it will vary depending upon the exercise, the intensity that you train at. That's everything because again that determines where the the offramps are. If you're going really super intense with different techniques, you you'll be able to do shorter workouts and fewer repetitions and still reach failure and still get a response.

But if you're not doing those things, then you're not going to see that. One final benefit here to this blue line because I want to, you know, really express here how important both of these approaches are in the big picture. But this blue line, don't let people tell you that you can only build strength in, let's say, the three, four, five rep range. If you started out doing 10 of this weight that you had here, and then you could do 11, and then you can do 12, and you can do 13, you're increasing your strength. Don't let anybody fool you.

you're getting stronger at that lift. When you get stronger here, what happens? It brings everything up. So, all of these lines here, this red dot, this blue dot has the strength of your blue dot here goes up and starts out at a higher point. The red dot is going to go along with it, right?

Because it's a higher rep range, but it's still your absolute level of strength. So, it's going to raise all boats. So, the idea is you don't want to eliminate one technique or one approach versus the other. You certainly don't want to avoid strength training. At some point, that matters, too.

But you want to train for both strength and hypertrophy. And you do want to explore these higher and lower rep ranges because they're both going to matter as long as you know how to apply them. Guys, if you're looking for a program where we do this, I actually have a brand new one coming out where we trade off the workout length for intensity. It's called Athlete Express. Available December 13th.

If you're looking for more programs, guys, where we use all the different techniques, you can find them over at athletex. com. If you found the video helpful, please share it with somebody else you think could use the the tutorial here to understand finally what they need to do. If you haven't done so, guys, subscribe. Make sure you watch every video as we put one out.
