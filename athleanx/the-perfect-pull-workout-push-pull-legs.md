...
pull portion of the PPL.

Now guys, I understand that when we talk about
...
consist primarily of chest, shoulders and triceps, and we're training them on one day.

We have the pulling muscles, which is basically
...
off on Sunday and then you come back, that's called a Synchronoss split.

But we favor an asynchronous split, adding
...
doing here. Let's start with pull one.

All right, so I mentioned those two pull workouts
...
That's not simply just one set. You guys know you want to ramp up to that
...
Number one, this is going to help offload
...
Now, I mentioned, if you're feeling fatigued
...
by powering through initiating with the lats as you see here.

You're doing two to three sets in the 10 to
...
do so with one of my favorite ways to do it and it's the dumbbell high pull.

Now, some might look at this and say, "Jeff,
...
to a vertical pole and getting the upper traps and upper back and into the rear delts.

Which brings us to now the bicep portion of
...
And here we get to do that by simply hanging
...
that, we superset this with, I know, a tricep exercise on pull day.

You're going to see as we build out this entire
...
no Athlete-X workout is complete without some additional corrective work at the end of this.

And one of my favorite all time movements
...
15 to 20, for three sets, with the focus being on quality, not quantity.

Think about doing 15 to 20 sets of one rather
...
This is not meant for progressively overloading
...
are going to be done with a weight that you can handle for about eight repetitions.

So, again not touching our maxes is on this
...
was somewhat taxed by the Snatch Grip Deadlift, then you'd want to switch the order here.

But we do a lot of group training work here,
...
have in terms of hernia.

So, we get grounded, and we get balanced around
...
That brings us from here to here, the Sternum
...
And you guys know, I wouldn't complete one
...
with a classic Tricep Pushdown.

It's three sets of six to eight on the barbell
...
as opposed to the first workout, which I thought was a little bit upper back, heavy in focus. This is the perfect time to do this, guys.

And again, as always, with all of your corrective
...
second so you can make sure you screenshot them and keep them and start working on these.

Remember, we're going to have the perfect
...
We actually have a push/pull legs work out,
