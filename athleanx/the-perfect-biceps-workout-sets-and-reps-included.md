...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=gozU3CUIizs"
cover: imgs/cover.jpg
description: The perfect biceps workout should consist of exercises that not only hit the long and short head but also the brachialis, a totally separate muscle. In addition, it must put the biceps through its full range of motion and utilize both the flexion of the elbow and the supination of the hand. That sai
language: en
---

# The PERFECT Biceps Workout (Sets and Reps Included)

The perfect biceps workout should consist of exercises that not only hit the long and short head but also the brachialis, a totally separate muscle. In addition, it must put the biceps through its full range of motion and utilize both the flexion of the elbow and the supination of the hand. That sai

What's up, guys? Jeff Cavaliere, ATHLEANX. com. Today I’m going to put together what I would
call the perfect bicep workout. Continuing the series.

We’re going to put heavy science into what
...
Right off the bat, we understand that the
...
how the bicep turns a corner and comes up here.

If you follow that line you can see a little
...
which enables us to do some different things to influence it over the shorthead.

Not isolate, but influence. Again, I would trace that out by going down,
...
Or we could use rotation, a different function
...
workout we have to acknowledge the different functions of the bicep. So, we know it’s an elbow flexor, right?

That’s obvious. But we should also know that it’s a supinator. The reason why it supinates the forearm is
...
If you follow that tendon – you can grab
...
to bend the elbow, or flex the elbow. So, we could put a number two right here.

Then number three, we know is to get a full
...
proper alignment with each other so the line of pull is optimal.

If I take a forearm that’s pronated, we
...
Either in the beginning, middle, or end of
...
in a curl, that’s the most difficult part. But this is pretty simple.

Well, we also know that we can take a band
...
with the right selection of exercises that we’re going to put into the perfect workout.

We’re going to have the representation of
...
That leaves me with this area here. That’s not the bicep, guys. That’s actually the brachialis. I’ve talked about this in another video. The brachialis is very influential in terms
of the width of your overall bicep when viewed from the front because it has a critical role
it plays along with your biceps.

We want to make sure we’re choosing exercises
...
exercises we can do with the biceps because we’re talking about a hinge joint.

While it does cross the shoulder and the longhead,
...
you many of them that you can incorporate right away into those. Finally, you never forget the big exercises.

Just like we did when we did the chest workout. We still did the bench-press, we still did
...
by exercise. You ready?

So, we start the perfect bicep workout off
...
When we start with a cheat curl we’re giving
...
curl we’re still able to keep the reps coming.

By doing that, remember, the position of the
...
another one of those heavy exercises that gives us the option to overload the biceps.

Probably my favorite of all time. I’ve talked about it before. It’s the weighted chin-up. Again, it’s not just doing that. It’s doing something else that’s very
important.

We’ve already talked about how it’s hitting
...
action of the bicep as well. We also get the action at the shoulder.

The one that helps us get the peak contraction
...
the weight off and go into a drop set.

Now we jump back up. We talked about intensity techniques. We could do that here as well. This is the peak contraction chin-up. What we’re doing here is using this as a
burnout to the previous set, where we’re only going to focus on repping out in that
final, contracted state of the biceps.

We know that we already have all three components
...
To me, that’s the fact that in both exercises
...
We can take advantage of this right here. Those strength curves. Remember when I drew on my forearm like a
...
We can have the benefit of having an exercise
...
If you do this perfect workout you’re going
...
one-third of that range of motion unaddressed.

We can choose an exercise that is going to
...
it’s on more stretch.

Now, we can take that even further with another
...
It’s a trifecta. It’s three exercises and it’s going to
...
Finally, we’re going to hit that all-important
...
What we do now is, we don’t stop there. Instead we go for our second rep and now we
...
Now, we do that, and we don’t stop there. Why? We want to intensify this and make it more
difficult. We now want to take the opposite rotation
of the shoulder. Instead of coming and rotating in, now we
rotate out.

External rotation of the shoulder, but it
...
inside here. Again, not isolating, but influencing.

You can feel that here. So now, you take it up and alternate these
...
more importantly, we’ve addresses every
...
exercises. That’s the thing.

You don’t have to sit here and bang out
...
com and get one of our ATHLEANX training programs. In the meantime, if you like the muscle marker
...
workouts in these series.

All right, guys. I’ll talk to you again soon. See you.
