...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=KCADorwJ6Ik"
cover: imgs/cover.jpg
description: The hip flexors are one of the first areas we rush to stretch since they tend to feel tight more often than any other muscle group.  The problem is, tightness can often be confused for weakness and when you stretch a weak muscle you are only making the problem worse.  In this video, I’m going to sho
language: en
---

# Stop Stretching Your Hip Flexors! (HERE'S WHY)

The hip flexors are one of the first areas we rush to stretch since they tend to feel tight more often than any other muscle group.  The problem is, tightness can often be confused for weakness and when you stretch a weak muscle you are only making the problem worse.  In this video, I’m going to sho
...
be stretching yours, or leaving them alone.

As a matter of fact, you might want to be
...
When we talk about the hip flexors it’s
...
about are the ones that bring it up higher than that.

Which is the Soas and the Iliacus. Those are the two where, when we talk about
...
So, when these are tight they could actually
...
here before you start stretching it.

A lot of times what we’re really hiding
...
or not the knee itself is capable of bending.

Really, ideally, down to about 80, or 90 degrees. Or is it more extended, like this? Or it could be combination of both because
...
tightness. But is it a quad tightness? The Rectus Femoris that we talked about?

Or is it more of an actual hip flexor? What you would do is, with the knee floating
...
got a true hip flexor tightness.

In which case, that’s when you want to actually
...
where I said in the beginning, your manifesting something far different. You’re probably manifesting a weak hip.

I’m going to show you how to test for that
...
about right now. That is a weak hip flexor.

Then all you’re doing is stretching it and
...
So, stand upright. Put your hands behind your head so you can’t
...
See if you can hold it up here for 15 seconds. So, lift off that surface so your hip is as
...
down below that isn’t really equipped to do what you’re asking it to do. Which is, flex above 90 degrees.

If you remember back to the anatomy we showed
...
We could just stand right here and pull the
...
to take it up above the 90-position and hold it up above 90.

So that would be a good indication. If you hold it here, and you drop it, and
...
You could actually go back into this position
...
You’re going to test both sides. Do you actually have a hip flexor tightness? Because if you don’t and you stretch it,
...
On the other hand, if you have a weakness
...
Own this. If you have a hip flexor weakness then you’ve
...
what ATHLEANX is all about.

You can get our ATHLEANX training system over
...
As you can see, or hear, the voice is still
