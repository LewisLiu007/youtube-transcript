...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=AADG66TfLfI"
cover: imgs/cover.jpg
description: If you want to experience faster muscle growth then you need to find some way to include the 11 exercises in this video into your workouts. The key to building muscle is to utilize muscle growth training techniques that push you to your limits and unlock stimulus that create overload. The stretch re
language: en
---

# 11 EXERCISES FOR FASTER MUSCLE GROWTH!

If you want to experience faster muscle growth then you need to find some way to include the 11 exercises in this video into your workouts. The key to building muscle is to utilize muscle growth training techniques that push you to your limits and unlock stimulus that create overload. The stretch re

What's up, guys? Jeff Cavaliere. Athleanx. com. Today, we're going to cover 11 exercises that allow you to tap into one of the most overlooked 
and underutilized muscle functions to get better results.

It's called the stretch reflex. So today we're going to go through that oh, why are you back here again? Oh dude, stretch 
reflex. I'm What are you doing? I'm stretching.

It's not that kind of stretching. It's not? No. Oh, this is going to make my intro really awkward.

Feel good now? 11 exercises, guys, handpicked 
...
breaking them down. So now the stretch reflex is actually something we all have.
...
So here's what we're going to do, you're going to take this exercise and do it one 
...
second, and then allow sort of a drop into that stretch reflex and come out of it.
...
incline bicep curl. Why?

Because it gives you that opportunity to put the biceps in a stretch 
...
we can contract the triceps we have to momentarily relax the biceps to allow for a greater stretch. That momentary contraction of the triceps gives you that relaxation in the biceps, that triggers 
a stretch reflex, which allows for that greater strength in contraction out of the bottom.
...
out you got to make sure that you get your arms up out in front of your body.

And there's no 
easier place to start than right here on a lap pull down. But you're not going to do this. You're not going to do the overhand lap pull down. Now there's nothing wrong with this. I've 
done this exercise a million times and love it, but when you're trying to tap into the stretch 
reflex, then you've got to switch your hands to this position.

Why? It's not just about the hands, 
...
now we come down, and we can do them in the same way.

We either can do them the standard way of 
...
and pull down again. Now we can do this to other exercises.

One of the ways I like to do it is with 
...
The second version of this would once again be get the hands 
up, hold for a brief second, allow it to drop, and then come back into a more powerful contraction. The last exercise is one that I actually credit to my friend and colleague John Meadows, and it's 
...
quickly roll it back and right up into the rep.

More powerful contraction, more muscle fiber 
...
don't even do the exercise.

However, you could do the standing version here, which is the 3D cable 
...
Whenever you're training your chest, you want to make sure that you take your traps and 
...
explosive. So you might be wondering, Well, Jeff, what about a dip?

A dip is a great exercise for 
the chest that actually does place a good stretch on the pecs, especially those lower pec fibers. However, I wouldn't use it as a choice here because you're already in a vulnerable position at 
...
However, the side lateral raise, as you can see here, has its limitations, 
...
stopped by my own leg in the lateral raise.

I can go across my body, further out in front, and get 
that stretch that we're looking for. And again, we can do this in that one and a quarter way, 
take it up just a little bit and then drop it and more forcefully come out of the bottom here. The choice is up to you, it depends on your level of experience, but this is the way to do it if 
...
However, you might be thinking, Oh, we're hitting our quads, right? No, the stretch reflex when applied to a squat, is actually placing it on the glutes. Because if you 
...
have to get your leg behind your body.

So this isn't going to cut it there. But we do know that 
...
of fact, the pause squat is done for a different reason.

Remember, there's different aspects to 
...
or not you're going to shift the focus from the hamstrings to the glutes.
...
the exercise if you're looking to get the stretch reflex on the hamstrings.
...
com. If you haven't already done so, guys, make sure you click subscribe and turn 
