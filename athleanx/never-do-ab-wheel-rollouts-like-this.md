...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=A3uK5TPzHq8"
cover: imgs/cover.jpg
description: Ab wheel rollouts are one of the most commonly performed ab exercises in the gym.  Given their ease of setup, they are actually a great exercise for home workouts too since you can do them on the floor with very little space and one inexpensive ab wheel.  The problem is, the ab rollout is also one o
language: en
---

# Never Do Ab Wheel Rollouts Like This!

Ab wheel rollouts are one of the most commonly performed ab exercises in the gym.  Given their ease of setup, they are actually a great exercise for home workouts too since you can do them on the floor with very little space and one inexpensive ab wheel.  The problem is, the ab rollout is also one o

What's up, guys? Jeff Cavaliere, ATHLEANX. com. Today I want to talk to you all about the
ab-wheel rollout. More specifically, how to nail it every, single
time.

If you don’t, this exercise does not belong
...
focus on three separate areas. One is the setup.

The second part is the execution. The third part is pulling the wheel back to
you. Those are the three areas. Obviously, every exercise is made up of those
three components, but in this case people tend to screw up in those three areas. So we want to cover all of them.

So when you're getting setup for the exercise
...
exercise it's not the only one.

So when you get into this position here, and
...
So watch what I'll do instead. I'll do more of a cat and camel here, where
...
position from an anterior tilt.

So now when I'm in this position I want to
...
Whereas the more advanced, you can go all
...
in. you want to keep that nice, and tight throughout. So now here's the key for me.

When you're coming back in, what is initiating
the pulling? If you're letting your hips do the work you're
ruining all the good work you established to this point. That's what a lot of people do. When people say "I'll do hundreds of ab rollouts. " Not if you're doing them right.

If you go out and your first move is to pull
...
hips lead the way. Make the wheel and the hips move together.

Now you can test yourself, and there's a great
...
bench on the way back in I didn't do that rep correctly.

I let my hips dominate, and I let it lead
...
and the hips moving together in sync.

You'll see here when I get to the top my butt
...
single time. Guys, it rolls over to all our ab training. It's not just trying to crank out reps.

I think this is where this gets bastardized
...
but that every, single thing you do; then head to ATHLEANX.

com right now and get one
...
As long as you're doing this right I promise
