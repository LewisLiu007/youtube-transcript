...
channel: ATHLEAN-X™
url: "https://www.youtube.com/watch?v=TXCp7SZKkUI"
cover: imgs/cover.jpg
description: If you have skinny triceps that you want to make wider, especially when viewed from behind, then you are going to want to watch this video.  Here, I’m going to show you the best way to widen your triceps and get bigger, thicker arms in the process.  Many times people focus on the front of their arms
language: en
---

# How to Get Wider Triceps (WORKS EVERY TIME!)

If you have skinny triceps that you want to make wider, especially when viewed from behind, then you are going to want to watch this video.  Here, I’m going to show you the best way to widen your triceps and get bigger, thicker arms in the process.  Many times people focus on the front of their arms

What's up, guys? Jeff Cavaliere, ATHLEANX. com. Today I want to help you guys do something
we started to do in a video prior. That is to fill up these shirt sleeves.

We want to talk about, as we've done in the
...
damn impressive triceps when viewed from the side.

That is because the lateral head – one of
...
plays an important role in filling out those shirt sleeves, isn't developed as much.

If you have the same issue as him, I want
...
of the triceps is coming from this area right here. That's the longhead.

The longhead is going to occupy 2/3 of the
...
that. Then, of course, this medial head.

The one that doesn't get much attention. It's certainly got the smallest area, but
...
other two heads that don’t cross the shoulder joint. But that's only half the equation.
...
That's my favorite of all time. That is this lying tricep extension. I'm using the easy curl bar here. One of the things I always focus on when I
...
stays angled backward the entire time.

But I do this, and when I drop down to the
...
For me, I want to pick an exercise that allows
...
Nothing else changes. I'm just trying to keep that bar as tight
...
is going to increase measurably.

Now, here's something if you're short on time. If you want to have a combo exercise you can
...
But after I get them up overhead, I then bend
...
and equate the two exercises.

The fact is, you're still able to go from
...
the elbow and it's providing stability to the elbow.

Mostly in a fully extended elbow. That's the key. If you want to get that medial head fully
...
triceps because all of them are geared at extending the elbow.

But whether or not you fully extend them is
...
It's not until I go from here to here that
...
body is cutting off that last inch or two, because it's damn hard.

When you add in, as you see me doing right
...
up, you want to make it more difficult. You want to make it do more work. Lastly, we come up here with this last exercise.

This is a dumbbell press with the elbows tucked
...
the sky as I come up. Why?

Because I can reinforce the full elongation
...
hitting this medial aspect of the elbow. The medial tricep.

I will say something very interesting here. Power lifters tend to have really well-developed
...
the stability to the elbow joint because of that lockout.

Second, because power lifters are going to
...
a bit attack plan to do the right thing.

It just takes the right attack plan to do
...
leave the gaps uncovered, we fill it in because we put the science back in strength; all our
programs are available over at ATHLEANX.
