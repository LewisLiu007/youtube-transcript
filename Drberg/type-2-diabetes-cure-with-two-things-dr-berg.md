---
title: Type 2 Diabetes Cure With Two Things – Dr. Berg
channel: Dr. Eric Berg DC
url: "https://www.youtube.com/watch?v=hbLdXC3wHGE"
cover: imgs/cover.jpg
description: "For more info on health-related topics, go here: https://bit.ly/30mN7Xb"
language: en
---

# Type 2 Diabetes Cure With Two Things – Dr. Berg

For more info on health-related topics, go here: https://bit.ly/30mN7Xb

Hi guys. We're back again in this video. We're gonna talk about two things to focus on to rid diabetes type 2, okay? Out
of all the things that you can do, there are two things that are the most
important. The first question is, what is diabetes type 2?

It's a problem with
insulin. It's actually too much insulin. Type 1 is not enough insulin, but type 2
is too much insulin. So what is insulin? Insulin is a carbohydrate hormone.
...
which one of these do you think is more important to focus on, okay?
...
than if you cut off the sugar and kept eating all day long, okay? So this is the most important thing right here to focus on.
...
all the foods that turn into sugar very fast.

Like the breads, the pasta, cereal,
...
sports drinks. It's everywhere.

Juice, alcohol, there's a lot of hidden carbs
...
So you want to gradually phase into this. Now I created a real simple, easy, fast mini-course down below. You could click
that and just learn how to do this. Where I combined everything at once. So you'll
see huge changes just by tweaking these two things right here.

Alright? So if
you focus on that, that's going to be your greatest tool to overcome diabetes. Thanks for watching. Hey, thank you so much for watching. Keep spreading
