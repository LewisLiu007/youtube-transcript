---
title: What is Hypoglycemia and How to Fix it Naturally? – Dr.Berg
channel: Dr. Eric Berg DC
url: "https://www.youtube.com/watch?v=n4hTBVFyyKs"
cover: imgs/cover.jpg
description: "(Get 10% Off: PSEGHD)"
language: en
---
...
sugars of 100. What does that mean?

I'll give you a little comparison. If you were to weigh let's say 180 pounds,
...
But the point is that we need this normal
...
They're going to experience all these, specifically
...
pocket, or glucose tablets.

In case your blood sugars run low, go ahead
...
stubbing your toe in the same spot?

The why is this: if you're taking medication
...
take a little less next time to even it out. That's one solution.

Next solution is to get out of the diet what
...
So there's a hormone that does the opposite,
...
to explain why. It's called glucagon. Glucagon, okay? So that kind of does the opposite of insulin.

So if insulin lowers blood sugars, glucagon
...
and glucagon are working together, all right? So now here's the question.

Why don't we just increase glucagon instead
...
ready for this? Protein.

Moderate amount of protein, not a lot. You just need a moderate ... between three
...
And it was like a switch. I instantly like could think again, I was
...
diet, and you're not having protein with each meal ...

and I'm not saying have a lot, just
...
plan for, like, insulin resistance and things like that.

But the point I want to make is instead of
...
or even some animal fats if you're ...

or even butter. The point is if you do that, that will not
...
so stop having the candy in the pocket. Don't do the glucose tablets.

They even have these little shakes you can
